...
<div class="breadcrumb">
	...
	<li><a href="can-connect-signalr.getListData.html">getListData</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect-signalr/tree/v0.0.1/docs/getListData.md">source</a></li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{Set}</code>: <p>Invokes the method specified by <a href="can-connect-signalr.signalR.html" title="">signalR</a>.getListName or
<a href="can-connect-signalr.signalR.html" title="">signalR</a>.name+&quot;GetList&quot;.</p>
</li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-connect-signalr/docs/getListData.md"},"description":"\n","title":"getListData","name":"can-connect-signalr.getListData","type":"function","parent":"can-connect-signalr/data-interface","signatures":[{"code":"connection.getListData(set)","description":"\n","params":[{"types":[{"type":"Set"}],"name":"set","description":"\n\n  Invokes the method specified by [can-connect-signalr.signalR].getListName or\n  [can-connect-signalr.signalR].name+\"GetList\".\n"}]}],"_curParam":{"types":[{"type":"Set"}],"name":"set","description":"\n\n  Invokes the method specified by [can-connect-signalr.signalR].getListName or\n  [can-connect-signalr.signalR].name+\"GetList\".\n"},"pathToRoot":".."};
</script>
</article>
