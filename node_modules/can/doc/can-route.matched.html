...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-route/tree/v3.0.5/can-route.js#L840">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-route.matched","type":"function","parent":"can-route.static","src":{"line":840,"codeLine":861,"path":"node_modules/can-route/can-route.js"},"description":"A compute representing the currently matched route. ","title":"matched","signatures":[{"code":"route.matched()","description":"","params":[],"returns":{"types":[{"type":"String"}],"description":"The currently matched route.\n"}}],"_curReturn":{"types":[{"type":"String"}],"description":"The currently matched route.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
