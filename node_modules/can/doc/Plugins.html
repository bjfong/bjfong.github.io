...
<head>
	<meta charset="utf-8">
	<title>CanJS - Developing Plugins</title>
...
<div class="breadcrumb">
	...
	<li><a href="Plugins.html">Developing Plugins</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/docs/can-guides/plugins.md">source</a></li>
    ...
    <section class="body">
    <p>In this guide you'll learn how to build a plugin for CanJS. As is standard with programming tutorials,
...
<ul>
<li>A valid manifest file (<a href="http://bower.io/#defining-a-package">bower.json</a>) in the root of the project</li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"docs/can-guides/plugins.md"},"description":"\n","name":"Plugins","title":"Developing Plugins","type":"page","parent":"contributing","order":0,"comment":" ","pathToRoot":".."};
</script>
</article>
