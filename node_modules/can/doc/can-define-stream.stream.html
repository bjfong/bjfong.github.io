...
<!--####################################################################
	...
	@typedef can-define-stream.stream
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - stream</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-define-stream.stream.html">stream</a></li>
  ...
  <section class="title">
    ...
    <p>Define a property value from a stream of values.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-define-stream/tree/v0.0.6/can-define-stream.js#L63">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>stream( setterStream )</code>
  </h2>
  <p>The <code>stream</code> behavior is an available property definition on the
...
Constructor function, Array, a getter expression, or setter expression.">PropDefinition</a> of all <a href="can-define.html" title="Exports the define method that defines observable properties and their behavior on a prototype object.">can-define</a> types.</p>
<p>It is useful for deriving values that <a href="can-define.types.get.html" title="Specify what happens when a certain property is read on a map. get functions
work like a can-compute and automatically update themselves when a dependent
observable value is changed.">get</a> can not, for example
deriving values based around the change in another value intead of the values themselves.</p>
...
<p>The property <strong>must</strong> be bound before a value can be read.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>setterStream</b> <code>{Stream}</code>: <p>The stream of values set on this property like <code>obj.prop = value</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Stream}</code>: <p>A stream whose last value will be used as the property value.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"typedef","name":"can-define-stream.stream","parent":"can-define-stream/behaviors","src":{"line":63,"codeLine":111,"path":"node_modules/can-define-stream/can-define-stream.js"},"description":"\nDefine a property value from a stream of values.\n","title":"stream","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"stream( setterStream )","description":"\n\nThe `stream` behavior is an available property definition on the\n[can-define.types.propDefinition] of all [can-define] types.\n\nIt is useful for deriving values that [can-define.types.get] can not, for example\nderiving values based around the change in another value intead of the values themselves.\n\n```js\nvar Person = DefineMap.extend({\n  name: \"string\",\n  lastValidName: {\n    stream: function(){\n      return this.stream(\".name\").filter(function(name){\n        return name.indexOf(\" \") >= 0;\n      })\n    }\n  }\n});\n\nvar me = new Person({name: \"James\"});\n\nme.on(\"lastValidName\", function(lastValid) {\n  console.log(lastValid)\n});\n\nme.name = \"JamesAtherton\";\n\nme.name = \"James Atherton\";\n//-> console.logs \"James Atherton\";\n\nme.name = \"JustinMeyer\";\n\nme.name = \"Justin Meyer\";\n//-> console.logs \"Justin Meyer\";\n```\n\nThe property __must__ be bound before a value can be read.\n","params":[{"types":[{"type":"Stream"}],"optional":true,"name":"setterStream","description":"The stream of values set on this property like `obj.prop = value`."}],"returns":{"types":[{"type":"Stream"}],"description":"A stream whose last value will be used as the property value.\n"}}],"_curParam":{"types":[{"type":"Stream"}],"optional":true,"name":"setterStream","description":"The stream of values set on this property like `obj.prop = value`."},"_curReturn":{"types":[{"type":"Stream"}],"description":"A stream whose last value will be used as the property value.\n"},"pathToRoot":".."};
</script>
</article>
