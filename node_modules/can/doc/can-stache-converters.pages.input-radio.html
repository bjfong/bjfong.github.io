...
<!--####################################################################
	...
	@page can-stache-converters.pages.input-radio
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.pages.input-radio.html">input[type=radio]</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-stache-converters/tree/v3.0.4/docs/input-radio.md">source</a></li>
...
<p>To bind to a radio input, if you have a set of boolean values you can bind to the input's <code>checked</code> property as you do with <a href="can-stache-converters.pages.input-checkbox.html" title="Cross bind a value to a checkbox.">input[type=checkbox]</a>.</p>
...
<p>More often than binding to boolean values of each radio's <code>checked</code> value, you will want to know what the <code>value</code> is of the radio group. Since each radio has it's own <code>value</code>, the radio's selected value is the value of the radio item that is selected.</p>
<p>Using the <a href="can-stache.registerConverter.html" title="Register a helper for bidirectional value conversion.">converter</a> <a href="can-stache-converters.equal.html" title="A converter that is usually for binding to a &lt;input type=&quot;radio&quot;&gt; group, so that a scope value can be set the radio group's selected value.">equal</a> you can bind a value within your scope to the radio group's selected value:</p>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-stache-converters/docs/input-radio.md"},"description":"\nCross bind a value to a radio input.\n","name":"can-stache-converters.pages.input-radio","title":"input[type=radio]","type":"page","parent":"can-stache-converters.pages","comment":" ","pathToRoot":".."};
</script>
</article>
