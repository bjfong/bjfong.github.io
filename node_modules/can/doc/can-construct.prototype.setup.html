...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-construct/tree/v3.0.4/can-construct.js#L668">source</a></li>
...
<div class="signature">
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array|undefined}</code>: <p>If an array is returned, the array's items are passed as
arguments to <a href="can-construct.prototype.init.html" title="Called when a new instance of a Construct is created.">init</a>. The following example always makes
