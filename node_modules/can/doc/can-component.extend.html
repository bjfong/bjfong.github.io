...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-component/tree/v3.0.3/docs/extend.md">source</a></li>
...
that is is used to render the component's template.</p></li>
<li><p><strong>view</strong> {<a href="can-component.prototype.view.html" title="Provides a template to render directly within the component's element. The template is rendered with the
component's can-component::ViewModel instance.  &lt;content/&gt; elements within the template are replaced by the source elements within the component's tag.">view</a>} - Specifies the template
...
<li><p><strong>helpers</strong> {<a href="can-component.prototype.helpers.html" title="Helper functions used with the component's template.">helpers</a>} - Specifies mustache helpers
used to render the component's template.</p></li>
</ul>
</li>
...
<p>Instead, components work more like HTML elements. To reuse functionality from a base component, build on top of it with parent components that wrap other components in their template and pass any needed viewModel properties via attributes.</p>
