...
<div class="breadcrumb">
	...
	<li><a href="can-stache-bindings.toChild.html">{to-child}</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-stache-bindings/tree/v3.0.5/docs/to-child.md">source</a></li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>child-prop</b> <code>{String}</code>: <p>The name of the property to set in the
...
<div class="signature">
  ...
  <p>Imports <a href="can-stache.key.html" title="A named reference to a value in the scope or helper scope in a template.">key</a> in the <a href="can-view-scope.html" title="Create a lookup node for keys.">scope</a> to <code>childProp</code> property or attribute on the element.</p>
...
<pre><code>&lt;input value=&quot;{{name}}&quot;/&gt;
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>{child-prop}=&quot;key&quot;</code> is used to pass values from the scope to a component.  You can use CallExpressions like:</p>
<pre><code>&lt;player-scores {scores}=&quot;game.scoresForPlayer('Alison')&quot;/&gt;
