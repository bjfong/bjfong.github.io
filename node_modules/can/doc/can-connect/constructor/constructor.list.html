...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Returns the data in its typed list form.</p>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.list( listInstanceData, set )</code>
  </h2>
  <p>Takes an object with a data property that is an array of instances returned by
<a href="constructor.hydrateInstance.html" title="Makes a type object given raw data.">hydrateInstance</a> and should return the right type of list.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>listInstanceData</b> <code>{Object}</code>: <p>An object that contains an array
of instances.</p>
</li>
        
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The set this list belongs to.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>The instances in the special list type.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>If you have a special type of list with helper functions you'd like to have available,
you can do that in <code>list</code>.  The following makes it so <code>getList</code> resolves to array-like
objects that have a <code>completed</code> function.</p>
<pre><code>var MyList = Object.create(Array.prototype);
...
<p>This allows:</p>
<pre><code>todosConnection.getList({}).then(function(todos){
  console.log(&quot;There are&quot;,todos.completed().length, &quot;completed todos&quot;)
});
</code></pre>
<p>Notice that we added the default <a href="../base/base.listSetProp.html" title="Specifies the property that uniquely identifies a list.">listSetProp</a> (<code>__listSet</code>) data on the list. This is useful
...
<script type="text/javascript">
  var docObject = {"description":"\nReturns the data in its typed list form.\n","title":"list","name":"can-connect/constructor/constructor.list","type":"property","parent":"can-connect/constructor/constructor.hydrators","signatures":[{"code":"connection.list( listInstanceData, set )","description":"\n\n  Takes an object with a data property that is an array of instances returned by\n  [can-connect/constructor/constructor.hydrateInstance] and should return the right type of list.\n","params":[{"types":[{"type":"Object","options":[{"name":"data","types":[{"type":"Array","template":[{"types":[{"type":"Instance"}]}]}]}]}],"name":"listInstanceData","description":"An object that contains an array\nof instances.\n"},{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set this list belongs to.\n"}],"returns":{"types":[{"type":"can-connect.List"}],"description":"The instances in the special list type.\n"}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set this list belongs to.\n"},"_curReturn":{"types":[{"type":"can-connect.List"}],"description":"The instances in the special list type.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
