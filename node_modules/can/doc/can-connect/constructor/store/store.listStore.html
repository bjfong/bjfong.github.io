...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>A store of lists mapped by <a href="../../base/base.listSet.html" title="Uniquely identify the set a list represents.">listSet</a>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L130">source</a></li>
...
<div class="signature">
  ...
  <p>Stores lists by their <a href="../../base/base.listSet.html" title="Uniquely identify the set a list represents.">listSet</a> which have had
<a href="store.addListReference.html" title="Adds a reference to a list so it can be easily looked up.">addListReference</a> called more
times than <a href="store.deleteListReference.html" title="Removes a reference to a list by base.listSet so it can be garbage collected.">deleteListReference</a>.</p>
