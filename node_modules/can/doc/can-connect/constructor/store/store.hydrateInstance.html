...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Returns a instance given raw data.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L413">source</a></li>
...
<div class="signature">
  ...
  <p>Overwrites the base <code>hydratedInstance</code> so that if a matching instance is
in the <a href="store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a>, that instance will
be <a href="../constructor.updatedInstance.html" title="Updates the instance being updated with the result of connection.updateData.">updated</a> with <code>props</code> and returned.
If there isn't a matching instance, the base <code>hydrateInstance</code> will be called.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Instance}</code>: <p>A typed instance created or updated from <code>props</code>.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"src":{"line":413,"codeLine":429,"path":"node_modules/can-connect/constructor/store/store.js"},"type":"function","description":"\nReturns a instance given raw data.\n","title":"hydrateInstance","name":"can-connect/constructor/store/store.hydrateInstance","parent":"can-connect/constructor/store/store.hydrators","signatures":[{"code":"connection.hydrateInstance(props)","description":"\n\n  Overwrites the base `hydratedInstance` so that if a matching instance is\n  in the [can-connect/constructor/store/store.instanceStore], that instance will\n  be [can-connect/constructor/constructor.updatedInstance updated] with `props` and returned.\n  If there isn't a matching instance, the base `hydrateInstance` will be called.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"The raw data used to create an instance."}],"returns":{"types":[{"type":"Instance"}],"description":"A typed instance created or updated from `props`.\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"The raw data used to create an instance."},"_curReturn":{"types":[{"type":"Instance"}],"description":"A typed instance created or updated from `props`.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
