...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Overwrites <a href="../../connection.save.html" title="">connection.save</a> so any
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L558">source</a></li>
...
<pre><code>var promise = connection.save(todo5);
...
promise.then(function(){
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;instance&gt;}</code>: <p>The promise returned by the base connection's <a href="../../connection.save.html" title="">connection.save</a>.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/store/store.save","parent":"can-connect/constructor/store/store.crud","src":{"line":558,"codeLine":582,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nOverwrites [can-connect/connection.save] so any\n[can-connect/constructor/store/store.hydrateInstance hydrated instances] are kept in the\nstore until the response resolves.\n","title":"save","signatures":[{"code":"connection.save( instance )","description":"\n\n  Increments the request counter so this instance will be stored\n  and then decrements it after the request is complete.\n\n  ```\n  var promise = connection.save(todo5);\n  connection.instanceStore.get(\"5\") //-> todo5\n  promise.then(function(){\n    connection.instanceStore.has(\"5\") //-> false\n  })\n  ```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instance","description":"An typed instance."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"instance"}]}]}],"description":"The promise returned by the base connection's [can-connect/connection.save].\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"instance","description":"An typed instance."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"instance"}]}]}],"description":"The promise returned by the base connection's [can-connect/connection.save].\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
