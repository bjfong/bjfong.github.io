...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>A store of instances mapped by <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L112">source</a></li>
...
<div class="signature">
  ...
  <p>Stores instances by their <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a> which have had
<a href="store.addInstanceReference.html" title="Adds a reference to an instance so it can be easily looked up.">addInstanceReference</a> called more
times than <a href="store.deleteInstanceReference.html" title="Removes a reference to an instance by base.id so it can be garbage collected.">deleteInstanceReference</a>.</p>
