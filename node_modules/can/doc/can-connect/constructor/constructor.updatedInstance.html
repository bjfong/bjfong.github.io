...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Updates the instance being updated with the result of <a href="../connection.updateData.html" title="Updates a record in the collection.">updateData</a>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L452">source</a></li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>The data from <a href="../connection.updateData.html" title="Updates a record in the collection.">updateData</a>.</p>
</li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/constructor.updatedInstance","parent":"can-connect/constructor/constructor.callbacks","src":{"line":452,"codeLine":467,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nUpdates the instance being updated with the result of [can-connect/connection.updateData].\n","title":"updatedInstance","signatures":[{"code":"connection.updatedInstance( instance, props )","description":"\n\n  Sets the properties in `instance` to match the properties and values in `props`\n  with the exception of [can-connect/base/base.idProp], which it leaves alone.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"The instance to update.\n"},{"types":[{"type":"Object","options":[]}],"name":"props","description":"The data from [can-connect/connection.updateData].\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"The data from [can-connect/connection.updateData].\n\t "},"pathToRoot":"../../.."};
</script>
</article>
