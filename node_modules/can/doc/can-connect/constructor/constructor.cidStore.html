...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L107">source</a></li>
...
<div class="signature">
  ...
  <p>The <code>cidStore</code> is used to temporarily hold references to instances by <a href="../../can-util/js/cid/cid.html" title="can-util/js/cid/cid">cid</a> that don't
yet have an id which are in the process of being created.</p>
