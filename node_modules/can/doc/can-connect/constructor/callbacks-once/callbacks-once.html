...
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/constructor/callbacks-once/callbacks-once</title>
  ...
  <li>
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks-once.createdData.html"
...
as the new response data.">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks-once.destroyedData.html"
							title="Called with the resolved response data
...
as the new response data.">
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks-once.updatedData.html"
							title="Called with the resolved response data
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/constructor/callbacks-once/callbacks-once</h1>
		<div>module</div>
	</div>
	
  
	<section class="description">
    <p>Prevents unecessary calls to the instance callback methods.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/callbacks-once/callbacks-once.js">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>constructorCallbacksOnce( baseConnection )</code>
  </h2>
  <p>Prevents duplicate calls to the instance callback methods by tracking
the last data the methods were called with.  If called with the
same data again, it does not call the base connection's instance callback.</p>
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/constructor/callbacks-once/callbacks-once","type":"module","parent":"can-connect.behaviors","src":{"line":0,"codeLine":14,"path":"node_modules/can-connect/constructor/callbacks-once/callbacks-once.js"},"description":"\nPrevents unecessary calls to the instance callback methods.\n","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"constructorCallbacksOnce( baseConnection )","description":"\n\n  Prevents duplicate calls to the instance callback methods by tracking\n  the last data the methods were called with.  If called with the\n  same data again, it does not call the base connection's instance callback.\n\n\n","params":[]}],"pathToRoot":"../../../.."};
</script>
</article>
