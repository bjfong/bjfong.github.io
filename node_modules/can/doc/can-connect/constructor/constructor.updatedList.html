...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Updates a list with new data.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L470">source</a></li>
...
<div class="signature">
  ...
  <p><a href="constructor.hydrateInstance.html" title="Makes a type object given raw data.">Hydrates</a> instances with <code>listData</code>'s data
and attempts to merge them into <code>list</code>.  The merge is able to identify simple insertions
and removals of elements instead of replacing the entire list.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>The instance to update.</p>
</li>
        
          <li><b>listData</b> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>The raw data usd to update <code>list</code>.</p>
</li>
        
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The set of data <code>listData</code> represents.</p>
</li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/constructor.updatedList","parent":"can-connect/constructor/constructor.callbacks","src":{"line":470,"codeLine":488,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nUpdates a list with new data.\n","title":"updatedList","signatures":[{"code":"connection.updatedList( list, listData, set )","description":"\n\n  [can-connect/constructor/constructor.hydrateInstance Hydrates] instances with `listData`'s data\n  and attempts to merge them into `list`.  The merge is able to identify simple insertions\n  and removals of elements instead of replacing the entire list.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"list","description":"The instance to update.\n"},{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"The raw data usd to update `list`.\n"},{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set of data `listData` represents.\n\t "}]}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set of data `listData` represents.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
