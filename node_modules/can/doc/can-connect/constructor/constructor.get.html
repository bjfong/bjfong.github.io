...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L121">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.get(set)</code>
  </h2>
  <p>Gets an instance from <a href="../connection.getData.html" title="Retrieves a record.">getData</a> and runs the resulting data
through <a href="constructor.hydrateInstance.html" title="Makes a type object given raw data.">hydrateInstance</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>params</b> <code>{Object}</code>: <p>Data specifying the instance to retrieve.  Normally, this
looks like: <code>{id: 5}</code>.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Instance&gt;}</code>: <p>An instance that represents the data that was loaded.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Call <code>.get()</code> with the parameters that identify the instance
you want to load.  <code>.get()</code> will return a promise that resolves
to your instance.</p>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/constructor.get","parent":"can-connect/constructor/constructor.crud","src":{"line":121,"codeLine":150,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nGet a single instance from the \"data interface\".\n","title":"get","signatures":[{"code":"connection.get(set)","description":"\n\n  Gets an instance from [can-connect/connection.getData] and runs the resulting data\n  through [can-connect/constructor/constructor.hydrateInstance].\n","params":[{"types":[{"type":"Object","options":[]}],"name":"params","description":"Data specifying the instance to retrieve.  Normally, this\nlooks like: `{id: 5}`.\n"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Instance"}]}]}],"description":"An instance that represents the data that was loaded.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"params","description":"Data specifying the instance to retrieve.  Normally, this\nlooks like: `{id: 5}`.\n"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Instance"}]}]}],"description":"An instance that represents the data that was loaded.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
