...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Updates the instance being destroyed with the result of <a href="../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L500">source</a></li>
...
<div class="signature">
  ...
  <p>Sets the properties in <code>instance</code> to match the properties and values in <code>props</code>
with the exception of <a href="../base/base.idProp.html" title="">idProp</a>, which it leaves alone.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>The instance to update.</p>
</li>
        
          <li><b>props</b> <code>{Object}</code>: <p>The data from <a href="../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a>.</p>
</li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/constructor.destroyedInstance","parent":"can-connect/constructor/constructor.callbacks","src":{"line":500,"codeLine":515,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nUpdates the instance being destroyed with the result of [can-connect/connection.destroyData].\n","title":"destroyedInstance","signatures":[{"code":"connection.destroyedInstance( instance, props )","description":"\n\n  Sets the properties in `instance` to match the properties and values in `props`\n  with the exception of [can-connect/base/base.idProp], which it leaves alone.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"The instance to update.\n"},{"types":[{"type":"Object","options":[]}],"name":"props","description":"The data from [can-connect/connection.destroyData].\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"The data from [can-connect/connection.destroyData].\n\t "},"pathToRoot":"../../.."};
</script>
</article>
