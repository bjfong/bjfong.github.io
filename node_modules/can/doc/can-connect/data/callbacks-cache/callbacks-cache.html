...
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/data/callbacks-cache/callbacks-cache</title>
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							...
							title="Called with the resolved response data
of connection.createData. Calls createData on the base.cacheConnection.">
							createdData
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Called with the resolved response data
of connection.destroyData. Calls destroyData on the base.cacheConnection.">
							destroyedData
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Called with the resolved response data
of connection.updateData. Calls updateData on the base.cacheConnection.">
							updatedData
						</a>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/data/callbacks-cache/callbacks-cache</h1>
		<div>module</div>
	</div>
	
  
	<section class="description">
    <p>Callback <a href="../../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a> methods when <a href="../callbacks/callbacks.html" title="Calls callback methods as a result of raw DataInterface requests.">data interface callbacks</a>
are called.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/callbacks-cache/callbacks-cache.js">source</a></li>
...
<div class="signature">
  ...
  <p>Implements the <a href="../callbacks/callbacks.html" title="Calls callback methods as a result of raw DataInterface requests.">data callbacks</a> so that a corresponding method is called
on the <a href="../../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a>.This is
useful for making sure a <a href="../../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a> is updated whenever data is updated.</p>
