...
of <a href="../../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a>. Calls <code>destroyData</code> on the <a href="../../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/callbacks-cache/callbacks-cache.js#L35">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/data/callbacks-cache/callbacks-cache.destroyedData","type":"function","parent":"can-connect/data/callbacks-cache/callbacks-cache","src":{"line":35,"codeLine":42,"path":"node_modules/can-connect/data/callbacks-cache/callbacks-cache.js"},"description":"\nCalled with the resolved response data\nof [can-connect/connection.destroyData]. Calls `destroyData` on the [can-connect/base/base.cacheConnection].\n","title":"destroyedData","pathToRoot":"../../../.."};
</script>
</article>
