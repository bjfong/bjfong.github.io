...
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/data/combine-requests/combine-requests</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/data/combine-requests/combine-requests</h1>
		<div>module</div>
	</div>
	
  
	<section class="description">
    <p>Combines multiple incoming requests into one if possible.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/combine-requests/combine-requests.js#L8">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>dataCombineRequests( baseConnection )</code>
  </h2>
  <p>Overwrites <a href="../combine-requests.getListData.html" title="Tries to combine requests using set logic.">getListData</a> to collect the requested
sets for
some <a href="../combine-requests.time.html" title="Specifies the amount of time to wait to combine requests.">time</a>.  Once that time has expired, it tries
to take the <a href="../combine-requests.unionPendingRequests.html" title="">union</a> of those sets. It
...
<a href="../combine-requests.getSubset.html" title="Return the items that belong to an initial request.">subsets</a> of the unioned set data.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Create a connection with the <code>combine-requests</code> plugin like:</p>
<pre><code>var todosConnection = connect([
...
<p>By default, the following will only make a single request if made at the same time:</p>
...
<p>This is because <a href="https://github.com/canjs/can-set">can-set</a> knows that
<code>{userId: 5, type: &quot;critical&quot;}</code> and <code>{userId: 5}</code> are subsets of <code>{}</code>.</p>
<p>For more advanced combining, use set algebra.  The following supports
combining ranges:</p>
<pre><code>var todosConnection = connect([
  require(&quot;can-connect/data/combine-requests/combine-requests&quot;),
  require(&quot;can-connect/data/url/url&quot;)
...
<p>Now the following will make single request:</p>
