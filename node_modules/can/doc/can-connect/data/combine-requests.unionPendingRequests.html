...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/combine-requests/combine-requests.js#L80">source</a></li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>undefined</b> <code>{Array&lt;<a href="combine-requests.PendingRequest.html" title="">PendingRequest</a>&gt;}</code>: <p>An array of objects, each containing:</p>
<ul>
<li><code>set</code> - the requested set</li>
<li><code>deferred</code> - a deferred that will be resolved with this sets data</li>
</ul>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Array&lt;Object&gt;}</code>: <p>Returns an array of each of the unioned requests to be made.  Each unionized request should have:</p>
<ul>
<li><code>set</code> - the set to request</li>
<li><code>pendingRequests</code> - the array of <a href="combine-requests.PendingRequest.html" title="">pending requests</a> the set satisfies.</li>
</ul>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>This function gets called automatically.  However, it converts something like:</p>
<pre><code>[
