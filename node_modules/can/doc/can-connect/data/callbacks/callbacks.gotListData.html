...
<!--####################################################################
	...
	@function can-connect/data/callbacks/callbacks.gotListData
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - gotListData</title>
...
and Arrays.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks.createdData.html"
							title="">
							createdData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks.destroyedData.html"
							title="">
							destroyedData
						</a>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="callbacks.gotListData.html"
							title="">
							gotListData
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="callbacks.updatedData.html"
							title="">
							updatedData
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="callbacks.gotListData.html">gotListData</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/callbacks/callbacks.js#L15">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.gotListData(data, params, cid)</code>
  </h2>
  <p>Called with the resolved response data
of <a href="../../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a>. The result of this function will be used
as the new response data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>data</b> <code>{Object}</code>: <p>The raw data returned by the response.</p>
</li>
        
          <li><b>params</b> <code>{Object}</code>: <p>The parameters used to make this request.</p>
</li>
        
          <li><b>cid</b> <code>{Number}</code>: <p>The cid of the instance created.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>The raw data this request represents.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/data/callbacks/callbacks.gotListData","type":"function","parent":"can-connect/data/callbacks/callbacks","src":{"line":15,"codeLine":31,"path":"node_modules/can-connect/data/callbacks/callbacks.js"},"description":"\n","title":"gotListData","signatures":[{"code":"connection.gotListData(data, params, cid)","description":"\n\n  Called with the resolved response data\n  of [can-connect/connection.getListData]. The result of this function will be used\n  as the new response data.\n\n","params":[{"types":[{"type":"Object","options":[]}],"name":"data","description":"The raw data returned by the response."},{"types":[{"type":"Object","options":[]}],"name":"params","description":"The parameters used to make this request."},{"types":[{"type":"Number"}],"name":"cid","description":"The cid of the instance created."}],"returns":{"types":[{"type":"Object","options":[]}],"description":"The raw data this request represents.\n "}}],"_curParam":{"types":[{"type":"Number"}],"name":"cid","description":"The cid of the instance created."},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"The raw data this request represents.\n "},"pathToRoot":"../../../.."};
</script>
</article>
