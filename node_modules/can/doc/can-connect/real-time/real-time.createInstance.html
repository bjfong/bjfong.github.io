...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/real-time/real-time.js#L135">source</a></li>
...
<div class="signature">
  ...
  <p>If there is no instance in the <a href="../constructor/store/store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a>
for <code>props</code>'s <a href="../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a>, an instance is <a href="../constructor/constructor.hydrateInstance.html" title="Makes a type object given raw data.">hydrated</a>,
