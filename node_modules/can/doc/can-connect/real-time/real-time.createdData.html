...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/real-time/real-time.js#L194">source</a></li>
...
<p>Next, it goes through every list in the <a href="../constructor/store/store.listStore.html" title="A store of lists mapped by base.listSet.">listStore</a>,
test if the instance's data belongs in that list.  If it does,
adds the instance's data to the serialized list data and
<a href="../constructor/constructor.updatedList.html" title="Updates a list with new data.">updates the list</a>.</p>
