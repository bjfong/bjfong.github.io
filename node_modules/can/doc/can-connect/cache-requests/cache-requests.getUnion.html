...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Returns the union of the cached and needed data.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/cache-requests/cache-requests.js#L181">source</a></li>
...
<div class="signature">
  ...
  <p>Uses <a href="https://github.com/canjs/can-set#setgetunion">can-set.getUnion</a> to merge the two sets.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The set requested.</p>
</li>
        
          <li><b>diff</b> <code>{Object}</code>: <p>The result of <a href="cache-requests.getDiff.html" title="Compares the available set data to the requested data and returns
the data that should be loaded from the cache and the data loaded
from the base connection.">getDiff</a>.</p>
</li>
          ...
          <li><b>cachedData</b> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>The data loaded from the <a href="../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>Return the merged cached and requested data.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/cache-requests/cache-requests.getUnion","parent":"can-connect/cache-requests/cache-requests.algebra","src":{"line":181,"codeLine":198,"path":"node_modules/can-connect/cache-requests/cache-requests.js"},"description":"\nReturns the union of the cached and needed data.\n","title":"getUnion","signatures":[{"code":"connection.getUnion(set, diff, neededData, cachedData)","description":"\n\n  Uses [can-set.getUnion](https://github.com/canjs/can-set#setgetunion) to merge the two sets.\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set requested."},{"types":[{"type":"Object","options":[]}],"name":"diff","description":"The result of [can-connect/cache-requests/cache-requests.getDiff]."},{"types":[{"type":"can-connect.listData"}],"name":"neededData","description":"The data loaded from the base connection."},{"types":[{"type":"can-connect.listData"}],"name":"cachedData","description":"The data loaded from the [can-connect/base/base.cacheConnection].\n"}],"returns":{"types":[{"type":"can-connect.listData"}],"description":"Return the merged cached and requested data.\n\t "}}],"_curParam":{"types":[{"type":"can-connect.listData"}],"name":"cachedData","description":"The data loaded from the [can-connect/base/base.cacheConnection].\n"},"_curReturn":{"types":[{"type":"can-connect.listData"}],"description":"Return the merged cached and requested data.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
