...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Uniquely identify the set a list represents.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/base/base.js#L129">source</a></li>
...
<div class="signature">
  ...
  <p>Returns the <a href="base.listSetProp.html" title="Specifies the property that uniquely identifies a list.">listSetProp</a> if it exists.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>An object that can be passed to <code>JSON.stringify</code>
to represent the list.</p>
</p>
  </div>
...
<code>connection.listSet</code> method should return that.</p>
<p>Typically, an item's <code>set</code> is an expando property added to
a list.  For example, a list of todos might looks like todos
after the following has run:</p>
<pre><code>var todos = [{_id: 5, name: &quot;do the dishes&quot;}]
todos.set = {due: 'today'};
</code></pre>
<p>In this case <a href="base.listSetProp.html" title="Specifies the property that uniquely identifies a list.">listSetProp</a> should be set to <code>&quot;set&quot;</code>.</p>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/base/base.listSet","parent":"can-connect/base/base","src":{"line":129,"codeLine":164,"path":"node_modules/can-connect/base/base.js"},"description":"\nUniquely identify the set a list represents.\n","title":"listSet","signatures":[{"code":"connection.listSet(list)","description":"\n\n  Returns the [can-connect/base/base.listSetProp] if it exists.\n","params":[{"types":[{"type":"can-connect.List"}],"name":"list","description":"A list instance.\n"}],"returns":{"types":[{"type":"Object","options":[]}],"description":"An object that can be passed to `JSON.stringify`\nto represent the list.\n"}}],"_curParam":{"types":[{"type":"can-connect.List"}],"name":"list","description":"A list instance.\n"},"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"An object that can be passed to `JSON.stringify`\nto represent the list.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
