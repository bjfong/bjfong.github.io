...
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/base/base</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/base/base</h1>
		<div>module</div>
	</div>
	
  
	<section class="description">
    <p>The base behavior added to every <code>connect</code> behavior.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/base/base.js#L1">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>&quot;base&quot;</code> behavior is added automatically to every connection created by <code>connect</code>. So even we do:</p>
<pre><code>var connection = connect([],{});
</code></pre>
<p>The connection still has <code>&quot;base&quot;</code> functionality:</p>
...
<script type="text/javascript">
  var docObject = {"type":"module","name":"can-connect/base/base","parent":"can-connect.behaviors","src":{"line":1,"codeLine":25,"path":"node_modules/can-connect/base/base.js"},"description":"\nThe base behavior added to every `connect` behavior.\n","title":"","signatures":[{"code":"base(options)","description":"\n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
