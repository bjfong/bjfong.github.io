...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Creates a <code>Map</code> instance.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L188">source</a></li>
...
<div class="signature">
  ...
  <p>Uses the <a href="map._Map.html" title="Specify what type of Map should be hydrated.">Map</a> property if available, otherwise
creates the <a href="../../../can-util/js/types/types.DefaultMap.html" title="">DefaultMap</a>.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Map}</code>: <p>An observable map type.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/can/map/map.instance","parent":"can-connect/can/map/map.hydrators","src":{"line":188,"codeLine":201,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nCreates a `Map` instance.\n","title":"instance","signatures":[{"code":"connection.instance( props )","description":"\n\n  Uses the [can-connect/can/map/map._Map] property if available, otherwise\n  creates the [can-util/js/types/types.DefaultMap].\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"The raw instance data."}],"returns":{"types":[{"type":"Map"}],"description":"An observable map type.\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"The raw instance data."},"_curReturn":{"types":[{"type":"Map"}],"description":"An observable map type.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
