...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Updates the instance with the response from <a href="../../connection.updateData.html" title="Updates a record in the collection.">updateData</a>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L295">source</a></li>
...
&quot;updated&quot; event on the map and the map's constructor function.</p>
...
<script type="text/javascript">
  var docObject = {"src":{"line":295,"codeLine":306,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nUpdates the instance with the response from [can-connect/connection.updateData].\n","title":"updatedInstance","name":"can-connect/can/map/map.updatedInstance","parent":"can-connect/can/map/map.instance-callbacks","signatures":[{"code":"connection.createdInstance( instance, props )","description":"\n\n  Updates the instance with `props` and dispatches a\n  \"updated\" event on the map and the map's constructor function.\n\t ","params":[]}],"pathToRoot":"../../../.."};
</script>
</article>
