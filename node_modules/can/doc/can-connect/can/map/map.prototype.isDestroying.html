...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Returns if the map is currently being destroyed.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L540">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>map.isDestroying()</code>
  </h2>
  <p>Observes if the promise returned by <code>.destroy()</code> has completed.  This is
often used in template like:</p>
...
&lt;/button&gt;
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if <code>.destroy()</code> has been called but is not resolved yet.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"src":{"line":540,"codeLine":560,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nReturns if the map is currently being destroyed.\n","title":"isDestroying","name":"can-connect/can/map/map.prototype.isDestroying","parent":"can-connect/can/map/map.map","signatures":[{"code":"map.isDestroying()","description":"\n\nObserves if the promise returned by `.destroy()` has completed.  This is\noften used in template like:\n\n```\n<button ($click)=\"todo.destroy()\"\n   {{#todo.isDestroying}}disabled{{/todo.isDestroying}}>\n  X\n</button>\n```\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if `.destroy()` has been called but is not resolved yet.\n\t "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if `.destroy()` has been called but is not resolved yet.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
