...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Updates a list with response data.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L235">source</a></li>
...
<div class="signature">
  ...
  <p>Updates the list within a batch event. Overwrite this if you want custom updating behavior.</p>
