...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Creates a <code>List</code> instance given raw data.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L205">source</a></li>
...
<div class="signature">
  ...
  <p>Uses the <a href="map._List.html" title="Specify what type of CanList should be hydrated.">List</a> property if available, otherwise
creates the <a href="map._Map.html" title="Specify what type of Map should be hydrated.">Map</a>.List if available, and then finally
defaults to <a href="../../../can-util/js/types/types.DefaultList.html" title="">DefaultList</a>.</p>
<p>This will add properties on <code>listData</code> to the list too.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>An observable list.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/can/map/map.list","parent":"can-connect/can/map/map.hydrators","src":{"line":205,"codeLine":223,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nCreates a `List` instance given raw data.\n","title":"list","signatures":[{"code":"connection.list(listData, set)","description":"\n\n  Uses the [can-connect/can/map/map._List] property if available, otherwise\n  creates the [can-connect/can/map/map._Map].List if available, and then finally\n  defaults to [can-util/js/types/types.DefaultList].\n\n  This will add properties on `listData` to the list too.\n","params":[{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"The raw list data."},{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set the data belongs to."}],"returns":{"types":[{"type":"can-connect.List"}],"description":"An observable list.\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set the data belongs to."},"_curReturn":{"types":[{"type":"can-connect.List"}],"description":"An observable list.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
