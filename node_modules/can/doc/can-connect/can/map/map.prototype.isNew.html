...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Returns if the map has not been persisted.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L502">source</a></li>
...
<div class="signature">
  ...
  <p>Returns <code>true</code> if <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a> is 0 or truthy.</p>
...
<script type="text/javascript">
  var docObject = {"src":{"line":502,"codeLine":514,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nReturns if the map has not been persisted.\n","title":"isNew","name":"can-connect/can/map/map.prototype.isNew","parent":"can-connect/can/map/map.map","signatures":[{"code":"map.isNew()","description":"\n\n  Returns `true` if [can-connect/base/base.id] is 0 or truthy.\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"\n\t "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
