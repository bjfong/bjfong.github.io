...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Specify what type of <code>CanList</code> should be hydrated.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L143">source</a></li>
...
<div class="signature">
  ...
  <p>Defaults to <a href="map._Map.html" title="Specify what type of Map should be hydrated.">Map</a>'s <code>.List</code> and
then <a href="../../../can-util/js/types/types.DefaultList.html" title="">DefaultList</a> if <code>connection.List</code> is not specified.</p>
...
<script type="text/javascript">
  var docObject = {"src":{"line":143,"codeLine":188,"path":"node_modules/can-connect/can/map/map.js"},"type":"property","description":"\nSpecify what type of `CanList` should be hydrated.\n","types":[{"type":"CanList","description":"Defaults to [can-connect/can/map/map._Map]'s `.List` and\nthen [can-util/js/types/types.DefaultList] if `connection.List` is not specified.\n"}],"title":"List","name":"can-connect/can/map/map._List","parent":"can-connect/can/map/map.hydrators","comment":" ","pathToRoot":"../../../.."};
</script>
</article>
