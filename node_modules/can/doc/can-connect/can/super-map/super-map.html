...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/super-map/super-map.md">source</a></li>
...
<div class="signature">
  ...
  <p>Creates a connection with the following behaviors: <a href="../../constructor/constructor.html" title="Adds the ability to operate on special types instead of plain JavaScript Objects
and Arrays.">can-connect/constructor/constructor</a>,
<a href="../map/map.html" title="Make a connection use a map type.">can-connect/can/map/map</a>,
<a href="../../constructor/store/store.html" title="Supports saving and retrieving lists and instances in a store.">can-connect/constructor/store/store</a>,
<a href="../../data/callbacks/callbacks.html" title="Calls callback methods as a result of raw DataInterface requests.">can-connect/data/callbacks/callbacks</a>,
<a href="../../data/callbacks-cache/callbacks-cache.html" title="Callback base.cacheConnection methods when data interface callbacks
are called.">can-connect/data/callbacks-cache/callbacks-cache</a>,
<a href="../../data/combine-requests/combine-requests.html" title="Combines multiple incoming requests into one if possible.">can-connect/data/combine-requests/combine-requests</a>,
...
<a href="../../data/url/url.html" title="">can-connect/data/url/url</a>,
<a href="../../real-time/real-time.html" title="Update lists to include or exclude instances based
on set logic.">can-connect/real-time/real-time</a>,
<a href="../../fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">can-connect/fall-through-cache/fall-through-cache</a>,
<a href="../../constructor/callbacks-once/callbacks-once.html" title="Prevents unecessary calls to the instance callback methods.">can-connect/constructor/callbacks-once/callbacks-once</a>.</p>
<p>And creates a <a href="../../data/localstorage-cache/localstorage-cache.html" title="Saves raw data in localStorage.">can-connect/data/localstorage-cache/localstorage-cache</a> to use as a <a href="../../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a>.</p>
...
<p><a href="../map/map.html" title="Make a connection use a map type.">can-connect/can/map/map</a> adds CRUD methods to the <code>Map</code> option, you can use those to create,
