...
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/can/ref/ref</title>
	...
	<ul>
					...
					<li class="
						...
						<a class="property"
							...
							title="can-connect/can/ref/ref.Map.Ref">
							Map.Ref
						</a>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/can/ref/ref</h1>
		<div>module</div>
	</div>
	
  
	<section class="description">
    <p>Handle references to instances in the raw data returned by the server.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/ref/ref.js">source</a></li>
...
<div class="signature">
  ...
  <p>Makes a reference type that loads the related type or holds onto an existing one. This handles circular references and loads relevant data as needed.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>baseConnection</b> <code>{connection}</code>: <p>The base connection should have <a href="../map/map.html" title="Make a connection use a map type.">can-connect/can/map/map</a>
...
<p>Now, <code>teamRef</code> is a <a href="ref.Map.Ref.html" title="can-connect/can/ref/ref.Map.Ref">Map.Ref</a> type, which will
...
<p>The values of other properties and methods on the <a href="ref.Map.Ref.html" title="can-connect/can/ref/ref.Map.Ref">Map.Ref</a> type
are determined by if the reference was populated or the referenced item already exists
in the <a href="../../constructor/store/store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a>.</p>
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/can/ref/ref","type":"module","parent":"can-connect.behaviors","src":{"line":0,"codeLine":145,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"Handle references to instances in the raw data returned by the server. \n","title":"","types":[{"type":"connect.Behavior"}],"signatures":[{"code":"canRef( baseConnection )","description":"\n\n  Makes a reference type that loads the related type or holds onto an existing one. This handles circular references and loads relevant data as needed.\n","params":[{"types":[{"type":"connection"}],"name":"baseConnection","description":"The base connection should have [can-connect/can/map/map]\nalready applied to it.\n"}]}],"_curParam":{"types":[{"type":"connection"}],"name":"baseConnection","description":"The base connection should have [can-connect/can/map/map]\nalready applied to it.\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
