...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/ref/ref.js#L325">source</a></li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.prototype.serialize","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":325,"codeLine":332,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"","title":"serialize","signatures":[{"code":"ref.serialize","description":"\n\treturns the `idProp`","params":[],"returns":{"types":[{"type":"string"}],"description":"idProp\n "}}],"_curReturn":{"types":[{"type":"string"}],"description":"idProp\n "},"pathToRoot":"../../../.."};
</script>
</article>
