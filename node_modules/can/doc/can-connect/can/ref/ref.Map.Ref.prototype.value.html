...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/ref/ref.js#L243">source</a></li>
...
<div class="signature">
  ...
  <pre><code>returns the actual object that reference points to
</code></pre>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{object}</code>: <p>actual object that reference points to</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/can/ref/ref.Map.Ref.prototype.value","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":243,"codeLine":250,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"","types":[{"type":"*"}],"title":"value","signatures":[{"code":"ref.value","description":"\n\treturns the actual object that reference points to","params":[],"returns":{"types":[{"type":"object"}],"description":"actual object that reference points to\n\t "}}],"_curReturn":{"types":[{"type":"object"}],"description":"actual object that reference points to\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
