...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/docs/data_interface/data_interface.md">source</a></li>
...
data comprised of plain JavaScript Objects, Arrays and primitive types.<br />
This is in contrast to the <a href="InstanceInterface.html" title="">InstanceInterface</a> methods that
...
<p>For example, <a href="data/url/url.html" title="">can-connect/data/url/url</a> implements these behaviors to
...
<p>The <a href="data/parse/parse.html" title="Extract response data into a format needed for other extensions.">can-connect/data/parse/parse</a> overwrites the <code>baseConnection</code> connection's methods to
