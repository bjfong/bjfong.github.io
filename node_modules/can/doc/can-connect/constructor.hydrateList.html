...
<!--####################################################################
	...
	@function can-connect/constructor.hydrateList
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
and Arrays.">
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.destroy.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.get.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.getList.html"
							title="Get a single instance from the &quot;data interface&quot;.">
							getList
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.save.html"
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.createdInstance.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.destroyedInstance.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.updatedInstance.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.updatedList.html"
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.hydrateInstance.html"
					...
					<li class="
           						...
           						">
						<a class="property"
							href="constructor/constructor.instance.html"
					...
					<li class="
           						...
           						">
						<a class="property"
							href="constructor/constructor.list.html"
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.serializeInstance.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.serializeList.html"
	...
	<ul>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="constructor/constructor.cidStore.html"
					...
					<li class="
           						...
           						">
						<a class="function"
							href="constructor/constructor.isNew.html"
...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Makes a list type object given raw data.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L195">source</a></li>
...
<div class="signature">
  ...
  <p>Calls <a href="constructor/constructor.hydrateInstance.html" title="Makes a type object given raw data.">hydrateInstance</a> with each raw instance data item and then
calls <a href="constructor/constructor.list.html" title="Returns the data in its typed list form.">list</a> with an array of the instances.  If <a href="constructor/constructor.list.html" title="Returns the data in its typed list form.">list</a>
is not provided, a normal array is used.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The set used to retrieve the list.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../can-connect.List.html" title="A list type.">List</a>}</code>: <p>The data type used to represent the list.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor.hydrateList","parent":"can-connect/constructor/constructor.hydrators","src":{"line":195,"codeLine":212,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nMakes a list type object given raw data.\n","title":"hydrateList","signatures":[{"code":"connection.hydrateList(listData, set)","description":"\n\n  Calls [can-connect/constructor/constructor.hydrateInstance] with each raw instance data item and then\n  calls [can-connect/constructor/constructor.list] with an array of the instances.  If [can-connect/constructor/constructor.list]\n  is not provided, a normal array is used.\n","params":[{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"Raw list data."},{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set used to retrieve the list.\n"}],"returns":{"types":[{"type":"can-connect.List"}],"description":"The data type used to represent the list.\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set used to retrieve the list.\n"},"_curReturn":{"types":[{"type":"can-connect.List"}],"description":"The data type used to represent the list.\n\t "},"pathToRoot":"../.."};
</script>
</article>
