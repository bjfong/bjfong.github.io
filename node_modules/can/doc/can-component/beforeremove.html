...
element with <a href="../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">(event)</a> bindings.  This is an additional
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-component/tree/v3.0.3/docs/beforeremove.md">source</a></li>
...
<div class="signature">
  ...
  <p>Uses <a href="../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">(event)</a> bindings to listen for a component's
beforeremove event.</p>
