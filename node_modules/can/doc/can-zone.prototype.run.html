...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-zone/tree/v0.6.0/docs/run.md">source</a></li>
...
<div class="signature">
  ...
  <p>Runs a function within a <a href="can-zone.html" title="">Zone</a>. Calling run will set the Zone's internal Promise which will only resolve once all asynchronous calls within <code>fn</code> are complete.</p>
