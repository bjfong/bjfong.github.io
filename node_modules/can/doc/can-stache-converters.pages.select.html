...
<!--####################################################################
	...
	@function can-stache-converters.pages.select
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.pages.select.html">select </a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-stache-converters/tree/v3.0.4/docs/select.md">source</a></li>
