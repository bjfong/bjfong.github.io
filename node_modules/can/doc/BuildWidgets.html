...
<head>
	<meta charset="utf-8">
	<title>CanJS - Build Widgets/UI Elements</title>
...
<div class="breadcrumb">
	...
	<li><a href="BuildWidgets.html">Build Widgets/UI Elements</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Build Widgets/UI Elements</h1>
		<div>page</div>
	</div>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/docs/can-guides/recipes/build-widgets.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"docs/can-guides/recipes/build-widgets.md"},"description":"\n","name":"BuildWidgets","title":"Build Widgets/UI Elements","type":"page","parent":"Recipes","order":5,"comment":" ","pathToRoot":".."};
</script>
</article>
