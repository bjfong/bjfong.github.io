...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-fixture/tree/v1.0.10/docs/fixture.delay.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-fixture/docs/fixture.delay.md"},"description":"","types":[{"type":"Number"}],"title":"delay","name":"can-fixture.delay","type":"property","parent":"can-fixture.properties","signatures":[{"code":"fixture.delay","description":"\n\nSets the delay until a response is fired in milliseconds.\n\n```js\nfixture.delay = 1000; // 1 second delay\n```\n","params":[]}],"pathToRoot":".."};
</script>
</article>
