...
<head>
	<meta charset="utf-8">
	<title>CanJS - Update Text in the Page</title>
...
<div class="breadcrumb">
	...
	<li><a href="UpdateText.html">Update Text in the Page</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/docs/can-guides/recipes/update-text.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"docs/can-guides/recipes/update-text.md"},"description":"\n","name":"UpdateText","title":"Update Text in the Page","type":"page","parent":"Recipes","order":2,"comment":" ","pathToRoot":".."};
</script>
</article>
