...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/docs/can-guides/experiment/atm/atm.md">source</a></li>
...
WebPack or Browserify.  Read <a href="setup.html" title="Get started with CanJS by installing it with npm, using a JS Bin, or just adding it to an HTML page with a &lt;script&gt; tag.">Setting up CanJS</a> on how to setup CanJS in a real app.</p></li>
...
and then initializes the <code>accountsPromise</code> and <code>transactions</code> property.</li>
</ul>
<p>Update the <code>TESTS</code> section of the <code>JavaScript</code> tab to:</p>
<ul>
<li>Test calling <code>pinNumber</code> moves the <code>state</code> to <code>&quot;choosingTransaction&quot;</code>.</li>
</ul>
<pre><code class="language-js">// ========================================
// CODE
// ========================================
...
<p>Update the <code>TESTS</code> section of the <code>JavaScript</code> tab to:</p>
<ul>
<li>Call <code>.chooseDeposit()</code> and verify the state moves to <code>&quot;pickingAccount&quot;</code>.</li>
</ul>
<pre><code class="language-js">// ========================================
// CODE
// ========================================
...
<blockquote>
<p>We will define <code>printReceiptAndExit</code> later!</p>
</blockquote>
...
value to <code>&quot;depositInfo&quot;</code> or <code>&quot;withdrawalInfo&quot;</code> depending on the type of the <code>currentTransaction</code>.</li>
...
the transaction was successful.</p>
<blockquote>
<p><strong>Optional:</strong> Challenge yourself by adding a test for the <code>withdrawalInfo</code> state of an atm instance.  Consider the progression of states needed to make it to the <code>withdrawalInfo</code> state.  How is it different from the <strong>ATM basics</strong> test we already have?</p>
</blockquote>
...
and then start another transaction.</p>
<h2>Printing Recipe page and test</h2>
<p>In this section, we will:</p>
<ul>
<li>Make it possible to see a receipt of all transactions and exit the ATM.</li>
</ul>
<p>Update the <code>HTML</code> tab to:</p>
<ul>
