...
<section class="title-footer">
		...
		<ul class="title-social">
			...
			<li>
			<a class="github-button nav-social" href="https://github.com/canjs/can-construct-super"
				data-count-href="/canjs/can-construct-super/stargazers"
				data-count-api="/repos/canjs/can-construct-super#stargazers_count">Star</a>
	  	</li>
		</ul>
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-construct-super/tree/v3.0.0/can-construct-super.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-construct-super/can-construct-super.md"},"description":"\ncan.Construct.super is a plugin that makes it easier to call base\nfunctions from inside inheriting functions.\n","type":"module","title":"","name":"can-construct-super","parent":"can-ecosystem","plugin":"can-construct-super","package":{"author":{"name":"Bitovi"},"bit-docs":{"dependencies":{"bit-docs-dev":"^0.0.3","bit-docs-generate-readme":"^0.0.8","bit-docs-glob-finder":"^0.0.5","bit-docs-js":"^0.0.3"},"glob":{"ignore":"node_modules/**/*","pattern":"can-construct-super.md"},"parent":"can-stache-bindings","readme":{"apis":"./docs/apis.json"}},"bugs":{"url":"https://github.com/canjs/can-construct-super/issues"},"dependencies":{"can-construct":"^3.0.0","can-util":"^3.0.0"},"description":"Provides a reference to the prototypal parent using this._super in can-construct objects","devDependencies":{"bit-docs":"0.0.7","jshint":"^2.9.3","steal":"^0.16.39","steal-qunit":"^0.1.3","steal-tools":"^0.16.8","testee":"^0.3.0-pre.1"},"directories":{},"dist":{"shasum":"bc4a1382999ad84b79d555e59f200eb3f56afab7","tarball":"https://registry.npmjs.org/can-construct-super/-/can-construct-super-3.0.0.tgz"},"gitHead":"72681928a1bdd3f0a0c8e1a4cb73ea265fc7e361","homepage":"https://github.com/canjs/can-construct-super#readme","keywords":["canjs","donejs"],"license":"MIT","main":"can-construct-super","maintainers":[{"email":"brad@bitovi.com","name":"bmomberger-bitovi"},{"email":"daff@neyeon.de","name":"daffl"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"john@ardea.io","name":"sinjhin"}],"name":"can-construct-super","optionalDependencies":{},"repository":{"type":"git","url":"git+https://github.com/canjs/can-construct-super.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"bit-docs","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"system":{"main":"can-construct-super","npmIgnore":["documentjs","testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.0.0"},"signatures":[{"code":"construct._super([...args])","description":"\n\nCalls the base constructor function's method.\n","params":[{"types":[{"type":"Any"}],"variable":true,"name":"args","description":"parameters to pass to the base function\n"}]}],"_curParam":{"types":[{"type":"Any"}],"variable":true,"name":"args","description":"parameters to pass to the base function\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
