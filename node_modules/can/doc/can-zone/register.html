...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>In order to do it's magic, <a href="../can-zone.html" title="">can-zone</a> has to register handlers for all of the common JavaScript async operations. If you have code (or a dependency with this code) that does:</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-zone/tree/v0.6.0/docs/register.md">source</a></li>
