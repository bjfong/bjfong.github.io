...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/dom/data/data.js#L13">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-util/dom/data/data","type":"module","parent":"can-util/dom","src":{"line":13,"codeLine":23,"path":"node_modules/can-util/dom/data/data.js"},"description":"Allows associating data as a key/value pair for a particular DOM Node.\n\n```js\nvar domData = require(\"can-util/dom/data/data\");\n```\n\n","title":"data","types":[{"type":"Object","options":[]}],"pathToRoot":"../../../.."};
</script>
</article>
