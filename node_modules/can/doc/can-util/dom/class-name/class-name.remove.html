...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/dom/class-name/class-name.js#L63">source</a></li>
...
<pre><code class="language-js">className.remove.call(el, &quot;container&quot;);
</code></pre>
