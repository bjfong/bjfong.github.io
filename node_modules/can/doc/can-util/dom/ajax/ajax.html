...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/dom/ajax/ajax.js#L5">source</a></li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>settings</b> <code>{Object}</code>: <p>Configuration options for the AJAX request.
The list of configuration options is the same as for <a href="http://api.jquery.com/jQuery.ajax/#jQuery-ajax-settings">jQuery.ajax</a>.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise}</code>: <p>A Promise that resolves to the data. The Promise instance is abortable and exposes an <code>abort</code> method.
Invoking abort on the Promise instance indirectly rejects it.</p>
</p>
  </div>
    ...
    <section class="body">
    <p><code>ajax( settings )</code> is used to make an asynchronous HTTP (AJAX) request
similar to <a href="http://api.jquery.com/jQuery.ajax/jQuery.ajax" title="http://api.jquery.com/jQuery.ajax/jQuery.ajax">http://api.jquery.com/jQuery.ajax/jQuery.ajax</a>. The example below
makes use of <a href="../frag/frag.html" title="Convert a String, HTMLElement, documentFragment, or contentArray into a documentFragment.">frag</a>.</p>
<pre><code>    ajax({
...
<script type="text/javascript">
  var docObject = {"name":"can-util/dom/ajax/ajax","type":"module","parent":"can-util/dom","src":{"line":5,"codeLine":29,"path":"node_modules/can-util/dom/ajax/ajax.js"},"description":"","title":"ajax","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"ajax(settings)","description":"","params":[{"types":[{"type":"Object","options":[]}],"name":"settings","description":"Configuration options for the AJAX request.\nThe list of configuration options is the same as for [jQuery.ajax](http://api.jquery.com/jQuery.ajax/#jQuery-ajax-settings)."}],"returns":{"types":[{"type":"Promise"}],"description":"A Promise that resolves to the data. The Promise instance is abortable and exposes an `abort` method.\n Invoking abort on the Promise instance indirectly rejects it.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"settings","description":"Configuration options for the AJAX request.\nThe list of configuration options is the same as for [jQuery.ajax](http://api.jquery.com/jQuery.ajax/#jQuery-ajax-settings)."},"_curReturn":{"types":[{"type":"Promise"}],"description":"A Promise that resolves to the data. The Promise instance is abortable and exposes an `abort` method.\n Invoking abort on the Promise instance indirectly rejects it.\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
