...
<!--####################################################################
	...
	@module can-util/dom/document/document
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/dom/document/document.js#L2">source</a></li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>document</b> <code>{Object}</code>: <p>An optional document-like object
to set as the context's document</p>
<p>Optionally sets, and returns, the document object for the context.</p>
...
<script type="text/javascript">
  var docObject = {"src":{"line":2,"codeLine":22,"path":"node_modules/can-util/dom/document/document.js"},"type":"module","description":"","title":"document","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-util/dom/document/document","parent":"can-util/dom","signatures":[{"code":"document(document)","description":"\n","params":[{"types":[{"type":"Object","options":[]}],"name":"document","description":"An optional document-like object \nto set as the context's document\n\nOptionally sets, and returns, the document object for the context.\n\n```js\nvar documentShim = { getElementById() {...} };\nvar domDocument = require(\"can-util/dom/document/document\");\ndomDocument(documentShim);\n\n...\n\ndomDocument().getElementById(\"foo\");\n```\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"document","description":"An optional document-like object \nto set as the context's document\n\nOptionally sets, and returns, the document object for the context.\n\n```js\nvar documentShim = { getElementById() {...} };\nvar domDocument = require(\"can-util/dom/document/document\");\ndomDocument(documentShim);\n\n...\n\ndomDocument().getElementById(\"foo\");\n```\n"},"pathToRoot":"../../../.."};
</script>
</article>
