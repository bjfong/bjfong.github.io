...
<!--####################################################################
	...
	@property can-util/js/types/types.iterator
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - iterator</title>
...
<div class="breadcrumb">
	...
	<li><a href="types.iterator.html">iterator</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/types/types.js#L101">source</a></li>
...
<div class="signature">
  ...
  <p>Used to implement an iterable object that can be used with <a href="../each/each.html" title="">each</a>. In browsers that support for/of this will be Symbol.iterator; in older browsers it will be a string, but is still useful with <a href="../each/each.html" title="">each</a>.</p>
...
<script type="text/javascript">
  var docObject = {"name":"can-util/js/types/types.iterator","type":"property","parent":"can-util/js/types/types","src":{"line":101,"codeLine":107,"path":"node_modules/can-util/js/types/types.js"},"description":"","types":[{"type":"Symbol","description":"\n\nUsed to implement an iterable object that can be used with [can-util/js/each/each]. In browsers that support for/of this will be Symbol.iterator; in older browsers it will be a string, but is still useful with [can-util/js/each/each].\n "}],"title":"iterator","pathToRoot":"../../../.."};
</script>
</article>
