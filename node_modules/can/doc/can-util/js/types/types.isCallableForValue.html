...
<!--####################################################################
	...
	@function can-util/js/types/types.isCallableForValue
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isCallableForValue</title>
...
way to observe those reads called within a given function.">
	...
	<ul>
					...
					<li class="
						...
						<a class="module"
							...
							title="can-util/js/assign/assign">
							./assign/
						</a>
					...
					<li class="
						...
						<a class="module"
							...
							title="can-util/js/deparam/deparam">
							./deparam/
						</a>
					...
					<li class="
						...
						<a class="module"
							...
							title="can-util/js/global/global">
							./global/
						</a>
					...
					<li class="
						...
						<a class="module"
							...
							title="can-util/js/is-browser-window/is-browser-window">
							./is-browser-window/
						</a>
					...
					<li class="
						...
						<a class="module"
							...
							title="Determines if the provided argument is a string.">
							./is-string/
						</a>
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="types.isCallableForValue.html"
							title="can-util/js/types/types.isCallableForValue">
							isCallableForValue
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="types.isCompute.html"
							title="can-util/js/types/types.isCompute">
							isCompute
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="types.isConstructor.html"
							title="can-util/js/types/types.isConstructor">
							isConstructor
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="types.isListLike.html"
							title="can-util/js/types/types.isListLike">
							isListLike
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="types.isMapLike.html"
							title="can-util/js/types/types.isMapLike">
							isMapLike
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="types.isPromise.html"
							title="can-util/js/types/types.isPromise">
							isPromise
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="types.iterator.html"
							title="can-util/js/types/types.iterator">
							iterator
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="types.queueTask.html"
							title="can-util/js/types/types.queueTask">
							queueTask
						</a>
					...
					<li class="
           						...
           						">
						<a class="function"
							href="types.unwrapElement.html"
							title="can-util/js/types/types.unwrapElement">
							unwrapElement
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="types.isCallableForValue.html">isCallableForValue</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/types/types.js#L81">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>types.isConstructor(obj)</code>
  </h2>
  <p>Returns true if <code>obj</code> looks like a function that should be read to get a value.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if the object should be called for a value.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-util/js/types/types.isCallableForValue","parent":"can-util/js/types/types","src":{"line":81,"codeLine":88,"path":"node_modules/can-util/js/types/types.js"},"description":"","title":"isCallableForValue","signatures":[{"code":"types.isConstructor(obj)","description":"\n  Returns true if `obj` looks like a function that should be read to get a value.\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if the object should be called for a value.\n "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if the object should be called for a value.\n "},"pathToRoot":"../../../.."};
</script>
</article>
