...
<!--####################################################################
	...
	@function can-util/js/types/types.isMapLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="types.isMapLike.html">isMapLike</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/types/types.js#L32">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>types.isMapLike(obj)</code>
  </h2>
  <p>Returns true if <code>obj</code> is an observable key-value pair type object.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if the object is map like.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-util/js/types/types.isMapLike","parent":"can-util/js/types/types","src":{"line":32,"codeLine":39,"path":"node_modules/can-util/js/types/types.js"},"description":"","title":"isMapLike","signatures":[{"code":"types.isMapLike(obj)","description":"\n  Returns true if `obj` is an observable key-value pair type object.\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if the object is map like.\n "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if the object is map like.\n "},"pathToRoot":"../../../.."};
</script>
</article>
