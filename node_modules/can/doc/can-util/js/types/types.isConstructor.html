...
<!--####################################################################
	...
	@function can-util/js/types/types.isConstructor
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isConstructor</title>
...
<div class="breadcrumb">
	...
	<li><a href="types.isConstructor.html">isConstructor</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/types/types.js#L62">source</a></li>
...
<div class="signature">
  ...
  <p>Returns true if <code>obj</code> looks like a constructor function to be called with <code>new</code>.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if the object is a constructor function.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-util/js/types/types.isConstructor","parent":"can-util/js/types/types","src":{"line":62,"codeLine":69,"path":"node_modules/can-util/js/types/types.js"},"description":"","title":"isConstructor","signatures":[{"code":"types.isConstructor(obj)","description":"\n  Returns true if `obj` looks like a constructor function to be called with `new`.\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if the object is a constructor function.\n "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if the object is a constructor function.\n "},"pathToRoot":"../../../.."};
</script>
</article>
