...
<head>
	<meta charset="utf-8">
	<title>CanJS - isBrowserWindow</title>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/is-browser-window/is-browser-window.js">source</a></li>
...
<pre><code class="language-js">var isBrowserWindow = require(&quot;can-util/js/is-browser-window/is-browser-window&quot;);
...
<script type="text/javascript">
  var docObject = {"type":"module","name":"can-util/js/is-browser-window/is-browser-window","parent":"can-util/js","src":{"line":0,"codeLine":19,"path":"node_modules/can-util/js/is-browser-window/is-browser-window.js"},"description":"","title":"isBrowserWindow","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"isBrowserWindow()","description":"\n\nReturns `true` if the code is running within a Browser window. Use this function if you need special code paths for when running in a Browser window, a Web Worker, or another environment (such as Node.js).\n\n```js\nvar isBrowserWindow = require(\"can-util/js/is-browser-window/is-browser-window\");\nvar GLOBAL = require(\"can-util/js/global/global\");\n\nif(isBrowserWindow()) {\n  console.log(GLOBAL() === window); // -> true\n}\n```\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"True if the environment is a Browser window.\n"}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"True if the environment is a Browser window.\n"},"pathToRoot":"../../../.."};
</script>
</article>
