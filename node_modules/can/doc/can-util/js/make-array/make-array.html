...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/make-array/make-array.js#L2">source</a></li>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>arr</b> <code>{ArrayLike}</code>: <p>any array-like object</p>
</li>
...
<script type="text/javascript">
  var docObject = {"type":"module","name":"can-util/js/make-array/make-array","parent":"can-util/js","src":{"line":2,"codeLine":11,"path":"node_modules/can-util/js/make-array/make-array.js"},"description":"","title":"makeArray","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"makeArray(arr)","description":"","params":[{"types":[{"type":"ArrayLike"}],"name":"arr","description":"any array-like object"}],"returns":{"types":[{"type":"Array","options":[]}],"description":"a JavaScript array object with the same elements as the passed-in ArrayLike\n\nmakeArray takes any array-like object (can-list, NodeList, etc.) and converts it to a JavaScript array\n"}}],"_curParam":{"types":[{"type":"ArrayLike"}],"name":"arr","description":"any array-like object"},"_curReturn":{"types":[{"type":"Array","options":[]}],"description":"a JavaScript array object with the same elements as the passed-in ArrayLike\n\nmakeArray takes any array-like object (can-list, NodeList, etc.) and converts it to a JavaScript array\n"},"pathToRoot":"../../../.."};
</script>
</article>
