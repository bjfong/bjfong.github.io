...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-zone/tree/v0.6.0/docs/current.md">source</a></li>
...
<div class="signature">
  ...
  <p>Represents the currently running <a href="can-zone.html" title="">zone</a>. If the code using <strong>Zone.current</strong> is not running within a zone the value will be undefined.</p>
