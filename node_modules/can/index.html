...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>CanJS is an evolving and improving set of client side JavaScript architectural libraries that balances innovation and stability. It targets experienced developers building complex applications with long futures ahead of them.<br />
<img
...
src="docs/images/home/Home-Tortoise-bw.png" style="padding-left: 40px;"/></p>
<p>If you're new to the project, the best place to start is the <a href="doc/guides.html" title="Welcome to CanJS! These guides are here to help you develop and improve your relationship with CanJS. After all, picking a JavaScript framework is a commitment.  We want CanJS to be the framework you marry.  This page helps you know how to advance through the different stages of this relationship:">Guides</a> page. There you'll
find CanJS's <a href="doc/guides/mission.html" title="Learn about CanJS's mission, why it matters, and how we've worked (and will keep working) to accomplish it.">Mission</a>, <a href="doc/guides/technical.html" title="Learn about CanJS's technical accomplishments.">Technical Highlights</a> and
...
<section class="title-footer">
		...
		<ul class="title-social">
			<li>
				<a class="npm-button" href="https://www.npmjs.com/package/can">
					<img src="https://img.shields.io/badge/npm%20package-3.2.0-brightgreen.svg" alt="npm package badge" />
				</a>
			</li>
			<li>
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/docs/can-canjs/canjs.md">source</a></li>
...
<ul>
<li><strong><a href="doc/can-compute.html" title="Create an observable value.">can-compute</a></strong> <small>3.0.4</small> Observable values and observable composite values
<ul>
...
<li><strong><a href="doc/can-connect.html" title="can-connect provides persisted data middleware. Use it to assemble powerful model layers for any JavaScript project.">can-connect</a></strong> <small>1.0.14</small> Data connection
<ul>
...
<li><strong><a href="doc/can-stache.html" title="Live binding Mustache and Handlebars-compatible templates.">can-stache</a></strong> <small>3.0.13</small> Live binding templates
<ul>
...
<li><strong><a href="doc/can-component.html" title="Create a custom element that can be used to manage widgets or application logic.">can-component</a></strong> <small>3.0.3</small> Custom elements
<ul>
...
<li><strong><a href="doc/can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a></strong> <small>3.0.5</small> View bindings
<ul>
...
<li><strong><a href="doc/can-route.html" title="Manage browser history and client state by synchronizing the window.location.hash with a map.">can-route</a></strong> <small>3.0.5</small> Routing
<ul>
...
location.pathname; // -&gt; &quot;/user&quot;">can-route-pushstate</a></strong> <small>3.0.1</small> Pushstate routing
<ul>
...
can.route. It can serve as both a traditional view and a traditional controller.">can-control</a></strong> <small>3.0.4</small> DOM widget constructor
<ul>
...
<li><strong><a href="doc/can-util.html" title="A set of utilities.">can-util</a></strong> <small>3.0.13</small> Low level JS and DOM utilities
<ul>
...
constructor function of your own.">can-construct</a></strong> <small>3.0.4</small> Extensible constructors
<ul>
...
way to observe those reads called within a given function.">can-observation</a></strong> <small>3.0.3</small> Observation notification
<ul>
...
<li><strong><a href="doc/can-simple-map.html" title="A performant live-bound map.">can-simple-map</a></strong> <small>3.1.1</small> Simple observable object
<ul>
...
<li><strong><a href="doc/can-view-callbacks.html" title="Registered callbacks for behaviors">can-view-callbacks</a></strong> <small>3.0.2</small> Register custom elements or attributes in can-stache
<ul>
...
<li><strong><a href="doc/can-view-model.html" title="Gets the ViewModel of an element.">can-view-model</a></strong> <small>3.1.2</small> Read a view-model from a custom element
<ul>
...
<li><strong><a href="doc/can-view-scope.html" title="Create a lookup node for keys.">can-view-scope</a></strong> <small>3.1.1</small> Scope lookup
<ul>
...
<li><strong><a href="doc/can-view-parser.html" title="Parse HTML and mustache tokens.">can-view-parser</a></strong> <small>3.0.2</small> Parses HTML and magic tags
<ul>
...
<li><strong><a href="doc/can-view-target.html" title="">can-view-target</a></strong> <small>3.0.4</small> A fast-path DOM fragment compile target
<ul>
...
<li><strong><a href="doc/can-view-live.html" title="Setup live-binding between the DOM and a compute manually.">can-view-live</a></strong> <small>3.0.4</small> Update the DOM with
a compute
<ul>
...
all items were removed.">can-view-nodelist</a></strong> <small>3.0.2</small> Maintains live-binding relationships
<ul>
...
<div class="module-list">
<ul>
<li><strong><a href="doc/can-fixture.html" title="can-fixture intercepts an AJAX request and simulates the response with a file or function.">can-fixture</a></strong> <small>1.0.10</small> Simulate AJAX requests
<ul>
...
<li><strong><a href="doc/can-fixture-socket.html" title="Simulate socket.io services.">can-fixture-socket</a></strong> <small>0.5.8</small> Simulate sockets
<ul>
<li><code>npm install can-fixture-socket --save</code></li>
<li><a class="github-button" href="https://github.com/canjs/can-fixture-socket" data-count-href="/canjs/can-fixture-socket/stargazers" data-count-api="/repos/canjs/can-fixture-socket#stargazers_count">Star</a></li>
</ul></li>
...
<li><strong><a href="doc/can-stache-converters.html" title="Provides a set of converters useful for two-way binding with form elements such as &lt;input&gt; and &lt;select&gt;.">can-stache-converters</a></strong> <small>3.0.4</small> Form two way bindings helpers
<ul>
...
<li><strong><a href="doc/steal-stache.html" title="A StealJS extension that allows stache templates as dependencies.">steal-stache</a></strong> <small>3.0.3</small> Import can-stache templates as dependencies with <a href="http://stealjs.com" title="StealJS">StealJS</a>
<ul>
...
<li><strong><a href="doc/can-view-import.html" title="">can-view-import</a></strong> <small>3.0.2</small> Import modules within can-stache templates
<ul>
...
<li><strong><a href="doc/can-view-autorender.html" title="A module that automatically renders script and other elements with
the can-autorender attribute. This function is useful to know when the templates have finished rendering.">can-view-autorender</a></strong> <small>3.0.3</small> Automatically
render templates in script tags.
<ul>
<li><code>npm install can-view-autorender --save</code></li>
<li><a class="github-button" href="https://github.com/canjs/can-view-autorender" data-count-href="/canjs/can-view-autorender/stargazers" data-count-api="/repos/canjs/can-view-autorender#stargazers_count">Star</a></li>
</ul></li>
<li><strong><a href="doc/can-jquery.html" title="Extensions to the event system so that can events and jQuery events are cross-bound.">can-jquery</a></strong> <small>3.0.3</small> jQuery integrations
<ul>
...
<li><strong><a href="doc/can-stream.html" title="Convert observable values into streams. Kefir is used internally to provide the stream functionality.">can-stream</a></strong> <small>0.0.4</small> Convert observable values into streams.
<ul>
<li><code>npm install can-stream --save</code></li>
<li><a class="github-button" href="https://github.com/canjs/can-stream" data-count-href="/canjs/can-stream/stargazers" data-count-api="/repos/canjs/can-stream#stargazers_count">Star</a></li>
</ul></li>
<li><strong><a href="doc/can-define-stream.html" title="Define property values using streams.  can-stream is used internally
to provide the stream functionality.">can-define-stream</a></strong> <small>0.0.6</small> Define property values using streams.
<ul>
<li><code>npm install can-define-stream --save</code></li>
<li><a class="github-button" href="https://github.com/canjs/can-define-stream" data-count-href="/canjs/can-define-stream/stargazers" data-count-api="/repos/canjs/can-define-stream#stargazers_count">Star</a></li>
</ul></li>
<li><strong><a href="doc/can-define-stream.html" title="Define property values using streams.  can-stream is used internally
to provide the stream functionality.">can-define-stream</a></strong> <small>0.0.6</small> Define property values using streams.
<ul>
...
<div class="module-list">
<ul>
<li><strong><a href="doc/can-map.html" title="Create observable objects.">can-map</a></strong> <small>3.0.3</small> Observable map
<ul>
...
<li><strong><a href="doc/can-list.html" title="">can-list</a></strong> <small>3.0.1</small> Observable lists
<ul>
...
of a Map.">can-map-define</a></strong> <small>3.0.1</small> Define property behavior
<ul>
...
<li><strong><a href="doc/can-map-backup.html" title="">can-map-backup</a></strong> <small>3.0.2</small> Save the last state
<ul>
...
<li><strong><a href="doc/can-view-href.html" title="Sets an element's href attribute so that it's url will set the specified attribute values on can-route.">can-view-href</a></strong> <small>3.0.3</small> Older routing view helpers
<ul>
...
with a version number, currently <code>3.2.0</code>.
...
with respect to the <a href="doc/can-core.html" title="The best, most hardened and generally useful libraries in CanJS.">Core</a> and <a href="doc/can-infrastructure.html" title="Utility libraries that power the core and ecosystem collection.">Infrastructure</a> collections
only.  Read the <a href="doc/guides/contributing/releases.html" title="Release and hosting information for CanJS maintainers.">Release Guide</a> for more information on CanJS's release process.</p>
<p>The sub-project package versions for <code>can 3.2.0</code>
...
CanJS <code>3.2.0</code>'s release.</p>
<p><strong>Core Collection</strong></p>
<pre><code>  &quot;can-component&quot;: &quot;3.0.3&quot;,
  &quot;can-compute&quot;: &quot;3.0.4&quot;,
  &quot;can-connect&quot;: &quot;1.0.14&quot;,
  &quot;can-define&quot;: &quot;1.0.4&quot;,
  &quot;can-route&quot;: &quot;3.0.5&quot;,
...
<pre><code class="language-js">  &quot;can-construct&quot;: &quot;3.0.5&quot;,
  &quot;can-control&quot;: &quot;3.0.4&quot;,
  &quot;can-event&quot;: &quot;3.0.1&quot;,
  &quot;can-observation&quot;: &quot;3.0.3&quot;,
  &quot;can-simple-map&quot;: &quot;3.1.1&quot;,
  &quot;can-util&quot;: &quot;3.0.13&quot;,
...
<pre><code>  &quot;can-construct-super&quot;: &quot;3.0.0&quot;,
  &quot;can-define-stream&quot;: &quot;0.0.6&quot;,
  &quot;can-fixture&quot;: &quot;1.0.10&quot;,
  &quot;can-fixture-socket&quot;: &quot;0.5.8&quot;,
  &quot;can-jquery&quot;: &quot;3.0.3&quot;,
  &quot;can-stache-converters&quot;: &quot;3.0.4&quot;,
  &quot;can-stream&quot;: &quot;0.0.4&quot;,
  &quot;can-vdom&quot;: &quot;3.0.1&quot;,
  &quot;can-view-autorender&quot;: &quot;3.0.3&quot;,
  &quot;can-view-import&quot;: &quot;3.0.2&quot;,
  &quot;can-zone&quot;: &quot;0.6.0&quot;,
  &quot;steal-stache&quot;: &quot;3.0.3&quot;,
</code></pre>
<p><strong>Legacy Collection</strong></p>
<pre><code class="language-js">  &quot;can-ejs&quot;: &quot;3.0.0&quot;,
  &quot;can-list&quot;: &quot;3.0.1&quot;,
  &quot;can-map&quot;: &quot;3.0.3&quot;,
...
<p>This is the that exports all of
the <a href="doc/can-core.html" title="The best, most hardened and generally useful libraries in CanJS.">Core</a> and <a href="doc/can-infrastructure.html" title="Utility libraries that power the core and ecosystem collection.">Infrastructure</a> module exports.</p>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"docs/can-canjs/canjs.md"},"description":"CanJS is an evolving and improving set of client side JavaScript architectural libraries that balances innovation and stability. It targets experienced developers building complex applications with long futures ahead of them.    \n<img\n    srcset=\"docs/images/home/Home-Tortoise-bw.png 1x, docs/images/home/Home-Tortoise-bw-x2.png 2x\"\n    src=\"docs/images/home/Home-Tortoise-bw.png\"\n    style=\"float:right; padding-right: 40px;\"/>\n<img\n    srcset=\"docs/images/home/Home-Hare-bw.png 1x, docs/images/home/Home-Hare-bw-x2.png 2x\"\n    src=\"docs/images/home/Home-Tortoise-bw.png\" style=\"padding-left: 40px;\"/>\n\nIf you're new to the project, the best place to start is the [guides] page. There you'll\nfind CanJS's [guides/mission Mission], [guides/technical Technical Highlights] and\nthe [guides/chat Chat], [guides/todomvc TodoMVC], and [guides/atm ATM] guide.\n\n","name":"canjs","title":"CanJS","type":"page","dest":"../index","outline":"0","package":{"name":"can","version":"3.2.0","main":"can.js","scripts":{"preversion":"npm test","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/","postversion":"git push --tags && git checkout master && git branch -D release && git push","testee":"testee test/index.html --browsers firefox","testee-production":"testee test/production.html --browsers firefox","http-server":"http-server -p 3000 --silent","test":"npm run test-development && npm run test-production ","test-development":"npm run build && npm run testee","test-production":"npm run build && npm run build-tests && npm run testee-production","ci":"npm run build && node test/test-sauce-labs.js","release:pre":"npm version prerelease && npm run build && npm publish","release:patch":"npm version patch && npm run build && npm publish","release:minor":"npm version minor && npm run build && npm publish","release:major":"npm version major && npm run build && npm publish","build":"node build.js","build-tests":"node test/build.js","document":"bit-docs"},"title":"CanJS","description":"MIT-licensed, client-side, JavaScript framework that makes building rich web applications easy.","keywords":["CanJS","DoneJS"],"author":{"name":"Bitovi","email":"contact@bitovi.com","web":"http://bitovi.com/"},"homepage":"http://canjs.com/","repository":{"type":"git","url":"git@github.com:canjs/canjs.git","github":"https://github.com/canjs/canjs"},"dependencies":{"can-component":"3.0.3","can-compute":"3.0.4","can-connect":"1.0.14","can-construct":"3.0.4","can-construct-super":"3.0.0","can-control":"3.0.4","can-define":"1.0.4","can-define-stream":"0.0.6","can-ejs":"3.0.0","can-event":"3.0.1","can-fixture":"1.0.10","can-fixture-socket":"^0.5.8","can-jquery":"3.0.3","can-list":"3.0.1","can-map":"3.0.3","can-map-backup":"3.0.2","can-map-define":"3.0.1","can-observation":"3.0.3","can-route":"3.0.5","can-route-pushstate":"3.0.1","can-set":"1.0.2","can-simple-dom":"1.0.2","can-simple-map":"3.1.1","can-stache":"3.0.13","can-stache-bindings":"3.0.5","can-stache-converters":"3.0.4","can-stream":"0.0.5","can-util":"3.0.13","can-vdom":"3.0.1","can-view-autorender":"3.0.3","can-view-callbacks":"3.0.2","can-view-href":"3.0.3","can-view-import":"3.0.2","can-view-live":"3.0.4","can-view-model":"3.1.2","can-view-nodelist":"3.0.2","can-view-parser":"3.0.2","can-view-scope":"3.1.1","can-view-target":"3.0.4","can-zone":"0.6.0"},"devDependencies":{"async":"^2.1.2","bit-docs":"^0.0.7","funcunit":"^3.1.0-pre.1","http-server":"^0.9.0","jquery":"^2.2.3","jquery-ui":"^1.12.0","saucelabs":"^1.3.0","socket.io-client":"^1.5.1","steal":"^0.16.4","steal-qunit":"^0.1.1","steal-stache":"^3.0.3","steal-tools":"^0.16.8","testee":"^0.2.5","wd":"^1.0.0"},"demos":["http://canjs.us/#examples","http://canjs.us/recipes"],"googleAnalyticsTrackingCode":"UA-2302003-11","licenses":[{"type":"MIT","url":"http://opensource.org/licenses/mit-license.php"}],"system":{"npmAlgorithm":"flat","main":"can","npmIgnore":["bit-docs","testee","async","saucelabs","wd","http-server"]},"bit-docs":{"dependencies":{"bit-docs-glob-finder":"^0.0.5","bit-docs-dev":"^0.0.3","bit-docs-js":"^0.0.6","bit-docs-tag-sourceref":"^0.0.3","bit-docs-generate-html":"^0.3.0","bit-docs-html-canjs":"^0.4.7","bit-docs-prettify":"^0.1.1","bit-docs-html-highlight-line":"^0.2.2","bit-docs-tag-demo":"^0.3.0","bit-docs-tag-package":"^0.0.5"},"glob":{"pattern":"{node_modules,docs}/{can-*,steal-stache}/**/*.{js,md}","ignore":["node_modules/can-wait/examples/**/*","node_modules/can-*/dist/**/*"]},"altVersions":{"2.3.27":"https://v2.canjs.com"},"parent":"canjs","minifyBuild":false}},"templateRender":["<%","%>"],"comment":" ","pathToRoot":""};
</script>
</article>
	  
        <footer><p>CanJS is part of <a href="http://donejs.com" target="_blank">DoneJS</a>. Created and maintained by the core <a href="https://donejs.com/About.html#section=section_Team" target="_blank">DoneJS team</a> and <a href="http://bitovi.com" target="_blank">Bitovi</a>. <strong>Currently 3.2.0.</strong></p></footer>
	      </div>
  </div>
</div>
