...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>A ZoneSpec is the way you tap into the lifecycle hooks of a <a href="can-zone.html" title="">Zone</a>. The hooks are described below.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-zone/tree/v0.6.0/docs/ZoneSpec.md">source</a></li>
...
<pre><code class="language-js">new Zone({
    created: function(){
      ...
      <li>
        ...
        <p>Called immediately before the <strong>Zone.prototype.run</strong> function is called.</p>
...
<p>Similar to the <a href="can-zone.html" title="">Zone</a> constructor you can either specify <a href="can-zone.ZoneSpec.html" title="A ZoneSpec is the way you tap into the lifecycle hooks of a Zone. The hooks are described below.
