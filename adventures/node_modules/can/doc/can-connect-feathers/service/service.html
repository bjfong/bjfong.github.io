...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect-feathers/tree/v2.0.0-beta.8/_docs/service/service.md">source</a></li>
...
<p>In the above example, both <code>Todo</code> and <code>Todo.connection</code> will have methods for handling data, as described in the <a href="../../can-connect.html" title="can-connect provides persisted data middleware. Use it to assemble powerful model layers for any JavaScript project.">basic use</a> section.</p>
