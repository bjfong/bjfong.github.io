...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-set/tree/v1.0.2/docs/can-set.Set.md">source</a></li>
...
<a href="https://en.wikipedia.org/wiki/Set_theory#Basic_concepts_and_notation" title="set">set</a> of data usually returned by the server.  For example,
