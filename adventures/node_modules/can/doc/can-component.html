...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-component/tree/v3.0.3/docs/component.md">source</a></li>
...
In 2.3, use the <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">bindings</a> syntaxes to setup bindings.</p>
...
<li><a href="can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">(event)</a>=<a href="can-stache/expressions/call.html" title="">expression</a> - event binding on the view model</li>
</ul>
