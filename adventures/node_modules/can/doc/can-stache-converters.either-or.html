...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>a [can-stache-registerConverter converter] that two-way binds to a checkbox two values provided as arguments. This converter is useful when you have a binary decision that your user will implicitly understand.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-stache-converters/tree/v3.0.4/docs/either-or.md">source</a></li>
...
&lt;input type=&quot;checkbox&quot; {($checked)}=&quot;either-or(~chosen, 'Batman', 'Superman')&quot;&gt; Batman?
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="can-compute.html" title="Create an observable value.">can-compute</a>}</code>: <p>A compute that will be used by <a href="can-stache-bindings.html" title="Provides template event, one-way bindings, and two-way bindings.">can-stache-bindings</a> as a getter/setter bound to the element.</p>
</p>
  </div>
