...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-construct/tree/v3.0.4/can-construct.js#L140">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-construct.constructorExtends","type":"property","parent":"can-construct.static","src":{"line":140,"codeLine":207,"path":"node_modules/can-construct/can-construct.js"},"description":"  Toggles the behavior of a constructor function called\n without the `new` keyword to extend the constructor function or\n create a new instance.\n\n ```js\n var animal = Animal();\n // vs\n var animal = new Animal();\n ```\n\n","types":[{"type":"Boolean"}],"title":"constructorExtends","comment":" ","pathToRoot":".."};
</script>
</article>
