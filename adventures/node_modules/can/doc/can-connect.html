...
<section class="title-footer">
		...
		<ul class="title-social">
			<li>
				<a class="npm-button" href="https://www.npmjs.com/package/can-connect">
					<img src="https://img.shields.io/badge/npm%20package-1.0.14-brightgreen.svg" alt="npm package badge" />
				</a>
			</li>
			<li>
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can-connect.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-connect/can-connect.md"},"description":"`can-connect` provides persisted data middleware. Use it to assemble powerful model layers for any JavaScript project.\n\n","type":"module","title":"","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-connect","parent":"can-core","outline":"2","package":{"author":{"name":"Bitovi"},"bugs":{"url":"https://github.com/canjs/can-connect/issues"},"dependencies":{"can-compute":"^3.0.0","can-define":"^1.0.0","can-event":"^3.0.1","can-list":"^3.0.0","can-map":"^3.0.1","can-observation":"^3.0.1","can-set":"^1.0.0","can-stache":"^3.0.1","can-stache-bindings":"^3.0.0","can-util":"^3.0.1","can-view-callbacks":"^3.0.0","can-view-nodelist":"^3.0.0","jquery":"^2.1.4","steal-stache":"^3.0.0"},"description":"Data connection middleware and utilities","devDependencies":{"can-fixture":"^0.1.0","jshint":"^2.9.1","steal":"^0.15.8","steal-qunit":"^0.1.3","steal-tools":"^0.15.5","testee":"^0.2.5"},"directories":{},"dist":{"shasum":"3ed3edc29c30d99d0dfba13973282c04d384894c","tarball":"https://registry.npmjs.org/can-connect/-/can-connect-1.0.14.tgz"},"engines":{"npm":"^3.0.0"},"gitHead":"563e93f9262ce06be2269dee459c46fe6397fd64","homepage":"https://github.com/canjs/can-connect#readme","keywords":["CanJS"],"license":"MIT","main":"can-connect.js","maintainers":[{"email":"akagomez@gmail.com","name":"akagomez"},{"email":"daff@neyeon.de","name":"daffl"},{"email":"garrett@garrettreed.co","name":"garrettreed"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"kphillips86@gmail.com","name":"phillipskevin"}],"name":"can-connect","optionalDependencies":{},"repository":{"type":"git","url":"git+https://github.com/canjs/can-connect.git"},"scripts":{"build":"node build.js","jshint":"jshint --config .jshintrc","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish","test":"npm run jshint && testee --browsers firefox test/test.html","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"system":{"ignoreBrowser":true,"npmAlgorithm":"flat","npmDependencies":["steal-qunit","can-fixture","can-define"],"npmIgnore":["devDependencies"]},"version":"1.0.14"},"signatures":[{"code":"connect(behaviors, options)","description":"\n\nGoes through every behavior and assembles them into a final\nconnection.\n\n```js\nvar connect = require(\"can-connect\");\nvar todosConnection = connect([\n    require(\"can-connect/data/url/url\"),\n    require(\"can-connect/constructor/constructor\")    \n],{\n    url: \"/api/todos\"\n});\n```\n","params":[{"types":[{"type":"Array","template":[{"types":[{"type":"can-connect/Behavior"}]}]}],"name":"behaviors","description":"An array of\nbehaviors that will be used to compose the final connection.\n"},{"types":[{"type":"Object","options":[]}],"name":"options","description":"an object of configuration\noptions.\n"}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"options","description":"an object of configuration\noptions.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
