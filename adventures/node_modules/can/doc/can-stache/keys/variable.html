...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-stache/tree/v3.0.13/docs/keys/variable.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-stache/docs/keys/variable.md"},"description":"\nStore a variable local to the template.\n","type":"typedef","title":"*variable","types":[{"type":"String"}],"name":"can-stache/keys/variable","parent":"can-stache/keys","signatures":[{"code":"*variable","description":"\n\nA placeholder for a value that is local to the template.\n\n```\n<drivers-licenses {^selected}=\"*selectedDriver\"/>\n<edit-driver {driver}=\"*selectedDriver\"/>\n```\n","params":[]}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
