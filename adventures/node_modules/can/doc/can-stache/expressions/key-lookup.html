...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-stache/tree/v3.0.13/docs/expressions/key-lookup.md">source</a></li>
...
<li><strong><a href="../keys/special.html" title="Event bindings and some helpers like can-stache.helpers.each
provide special values that start with % to prevent potential collisions with
other values.">special operator</a></strong> <code>{{%index}}</code> - lookup values in a special context provided by some helpers.</li>
...
<li><strong><a href="../keys/special.html" title="Event bindings and some helpers like can-stache.helpers.each
provide special values that start with % to prevent potential collisions with
other values.">at operator</a></strong> <code>{{method(@key}}</code> - pass a function instead of trying to read the value of the function.</li>
