...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/docs/data_interface/getSets.md">source</a></li>
...
connection.  This is useful for querying a <a href="base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a>
...
<pre><code class="language-js">connection.getSets().then(function(sets){
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p>Extensions like <a href="data/localstorage-cache/localstorage-cache.html" title="Saves raw data in localStorage.">can-connect/data/localstorage-cache/localstorage-cache</a> implement
