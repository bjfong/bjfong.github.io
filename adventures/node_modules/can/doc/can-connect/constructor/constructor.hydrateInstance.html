...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Makes a type object given raw data.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L232">source</a></li>
...
<div class="signature">
  ...
  <p>If <a href="constructor.instance.html" title="Returns the typed form of the raw data.">instance</a> is available passes <code>props</code> to that
and returns that value.  Otherwise, returns a clone of <code>props</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>The properties returned by <a href="../connection.getData.html" title="Retrieves a record.">getData</a>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>The data type used to represent the list.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/constructor.hydrateInstance","parent":"can-connect/constructor/constructor.hydrators","src":{"line":232,"codeLine":247,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nMakes a type object given raw data.\n","title":"hydrateInstance","signatures":[{"code":"connection.hydrateInstance(props)","description":"\n\n  If [can-connect/constructor/constructor.instance] is available passes `props` to that\n  and returns that value.  Otherwise, returns a clone of `props`.\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"The properties returned by [can-connect/connection.getData].\n"}],"returns":{"types":[{"type":"can-connect/Instance"}],"description":"The data type used to represent the list.\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"The properties returned by [can-connect/connection.getData].\n"},"_curReturn":{"types":[{"type":"can-connect/Instance"}],"description":"The data type used to represent the list.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
