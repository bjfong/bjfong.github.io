...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Returns the serialized form of an list.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L535">source</a></li>
...
<div class="signature">
  ...
  <p>This implementation simply returns an <code>Array</code> containing the result of
<a href="constructor.serializeInstance.html" title="Returns the serialized form of an instance.">serializeInstance</a> called on each item in the list.</p>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/constructor.serializeList","parent":"can-connect/constructor/constructor.serializers","src":{"line":535,"codeLine":551,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"Returns the serialized form of an list. \n","title":"serializeList","signatures":[{"code":"connection.serializeList( list )","description":"\n\n  This implementation simply returns an `Array` containing the result of\n  [can-connect/constructor/constructor.serializeInstance] called on each item in the list.\n","params":[{"types":[{"type":"can-connect.List"}],"name":"list","description":"The instance to serialize.\n"}],"returns":{"types":[{"type":"Object"},{"type":"Array","options":[]}],"description":"A serialized representation of the list.\n\n\t "}}],"_curParam":{"types":[{"type":"can-connect.List"}],"name":"list","description":"The instance to serialize.\n"},"_curReturn":{"types":[{"type":"Object"},{"type":"Array","options":[]}],"description":"A serialized representation of the list.\n\n\t "},"pathToRoot":"../../.."};
</script>
</article>
