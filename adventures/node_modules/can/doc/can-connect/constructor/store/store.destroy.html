...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Overwrites <a href="../../connection.destroy.html" title="">connection.destroy</a> so any
<a href="store.hydrateInstance.html" title="Returns a instance given raw data.">hydrated instances</a> are kept in the
store until the response resolves.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L603">source</a></li>
...
<div class="signature">
  ...
  <p>Increments the request counter so this instance will be stored
and then decrements it after the request is complete.</p>
<pre><code>var promise = connection.destroy(todo5);
...
promise.then(function(){
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{Object}</code>: <p>An typed instance.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;instance&gt;}</code>: <p>The promise returned by the base connection's <a href="../../connection.destroy.html" title="">connection.destroy</a>.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/store/store.destroy","parent":"can-connect/constructor/store/store.crud","src":{"line":603,"codeLine":627,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nOverwrites [can-connect/connection.destroy] so any\n[can-connect/constructor/store/store.hydrateInstance hydrated instances] are kept in the\nstore until the response resolves.\n","title":"destroy","signatures":[{"code":"connection.destroy( instance )","description":"\n\n  Increments the request counter so this instance will be stored\n  and then decrements it after the request is complete.\n\n  ```\n  var promise = connection.destroy(todo5);\n  connection.instanceStore.get(\"5\") //-> todo5\n  promise.then(function(){\n    connection.instanceStore.has(\"5\") //-> false\n  })\n  ```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instance","description":"An typed instance."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"instance"}]}]}],"description":"The promise returned by the base connection's [can-connect/connection.destroy].\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"instance","description":"An typed instance."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"instance"}]}]}],"description":"The promise returned by the base connection's [can-connect/connection.destroy].\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
