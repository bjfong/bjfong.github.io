...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Removes a reference to a list by <a href="../../base/base.listSet.html" title="Uniquely identify the set a list represents.">listSet</a> so it can be garbage collected.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L352">source</a></li>
...
<div class="signature">
  ...
  <p>Decrements the number of references to an list in the <a href="store.listStore.html" title="A store of lists mapped by base.listSet.">listStore</a>.
Removes the list if there are no longer any references.</p>
  ...
  <div class="parameters">
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>deleteListReference</code> is called to remove references to lists in
the <a href="store.listStore.html" title="A store of lists mapped by base.listSet.">listStore</a> so the lists maybe garbage
collected.  It's usually called when the application or some part of the application no
longer is interested in an list.</p>
<p><a href="store.addListReference.html" title="Adds a reference to a list so it can be easily looked up.">addListReference</a> has an example of adding
a list to the store.  The following continues that example to remove
the <code>dueToday</code> from the store:</p>
