...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Adds a reference to an instance so it can be easily looked up.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L163">source</a></li>
...
<div class="signature">
  ...
  <p>Adds a reference to an instance in the <a href="store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a> by <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a>.
The number of references are incremented.</p>
  ...
  <div class="parameters">
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <a href="store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a> contains a collection of instances
created for each <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a>. The <code>instanceStore</code> is used to prevent creating the
same instance multiple times.  Instances need to be added to this store for this behavior
to happen.  To do this, call <code>addInstanceReference</code> like the following:</p>
...
it would be the same instance.</p>
<pre><code>todoConnection.get({id: 5}).then(function( todo ){

  todo === originalTodo //-&gt; true
});
</code></pre>
<p>The <code>.getData</code>  response data is passed with <code>originalTodo</code> to <a href="../constructor.updatedInstance.html" title="Updates the instance being updated with the result of connection.updateData.">updatedInstance</a>
which can update the <code>originalTodo</code> with the new data.</p>
<p>All these instances stay in memory.  Use <a href="store.deleteInstanceReference.html" title="Removes a reference to an instance by base.id so it can be garbage collected.">deleteInstanceReference</a>
to remove them.</p>
<p>Typically, <code>addInstanceReference</code> is called when something expresses interest in the interest, such
as an event binding, and <code>deleteInstanceReference</code> is called when interest is removed.</p>
