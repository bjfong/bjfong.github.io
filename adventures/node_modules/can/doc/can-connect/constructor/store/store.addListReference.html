...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Adds a reference to a list so it can be easily looked up.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L281">source</a></li>
...
<div class="signature">
  ...
  <p>Adds a reference to a list in the <a href="store.listStore.html" title="A store of lists mapped by base.listSet.">listStore</a>.  The number of
references are incremented.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The set this list represents if it can't be identified with <a href="../../base/base.listSet.html" title="Uniquely identify the set a list represents.">listSet</a>.</p>
</li>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <a href="store.listStore.html" title="A store of lists mapped by base.listSet.">listStore</a> contains a collection of lists
created for each <a href="../../base/base.listSet.html" title="Uniquely identify the set a list represents.">listSet</a>. The <code>listStore</code> is used to prevent creating the
...
to happen.  To do this, call <code>addListReference</code> like the following:</p>
...
<p>Now, if you were to retrieve the same data sometime later,
it would be the same list.</p>
<pre><code>todoConnection.get({due: &quot;today&quot;}).then(function( todos ){

  todos === dueToday //-&gt; true
});
</code></pre>
<p>The <code>.getListData</code>  response data is passed with <code>dueToday</code> to <a href="../constructor.updatedList.html" title="Updates a list with new data.">updatedList</a>
which can update <code>dueToday</code> with the new data.</p>
<p>All these lists stay in memory.  Use <a href="store.deleteListReference.html" title="Removes a reference to a list by base.listSet so it can be garbage collected.">deleteListReference</a>
to remove them.</p>
...
<script type="text/javascript">
  var docObject = {"type":"property","name":"can-connect/constructor/store/store.addListReference","parent":"can-connect/constructor/store/store.stores","src":{"line":281,"codeLine":346,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nAdds a reference to a list so it can be easily looked up.\n","types":[{"type":"WeakReferenceMap"}],"title":"addListReference","signatures":[{"code":"connection.addListReference( list[, set] )","description":"\n\n  Adds a reference to a list in the [can-connect/constructor/store/store.listStore].  The number of\n  references are incremented.\n","params":[{"types":[{"type":"can-connect.List"}],"name":"list","description":"The list to add.\n"},{"types":[{"type":"can-set/Set"}],"optional":true,"name":"set","description":"The set this list represents if it can't be identified with [can-connect/base/base.listSet].\n"}]}],"_curParam":{"types":[{"type":"can-set/Set"}],"optional":true,"name":"set","description":"The set this list represents if it can't be identified with [can-connect/base/base.listSet].\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
