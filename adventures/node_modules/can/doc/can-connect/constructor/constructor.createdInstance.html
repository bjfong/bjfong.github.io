...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Updates the instance being created with the result of <a href="../connection.createData.html" title="Creates a new record in the connection.">createData</a>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L435">source</a></li>
...
<div class="signature">
  ...
  <p>Adds every property and value in <code>props</code> to <code>instance</code>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>props</b> <code>{Object}</code>: <p>The data from <a href="../connection.createData.html" title="Creates a new record in the connection.">createData</a>.</p>
</li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/constructor.createdInstance","parent":"can-connect/constructor/constructor.callbacks","src":{"line":435,"codeLine":449,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nUpdates the instance being created with the result of [can-connect/connection.createData].\n","title":"createdInstance","signatures":[{"code":"connection.createdInstance( instance, props )","description":"\n\n  Adds every property and value in `props` to `instance`.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"The instance to update.\n"},{"types":[{"type":"Object","options":[]}],"name":"props","description":"The data from [can-connect/connection.createData].\n\t "}]}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"The data from [can-connect/connection.createData].\n\t "},"pathToRoot":"../../.."};
</script>
</article>
