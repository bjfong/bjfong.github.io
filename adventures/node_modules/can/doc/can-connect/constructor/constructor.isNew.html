...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Returns if this instance has not been persisted.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L557">source</a></li>
...
<div class="signature">
  ...
  <p>Checks that the instance has an <a href="../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a>.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if the instance has not been persisted.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/constructor.isNew","parent":"can-connect/constructor/constructor.helpers","src":{"line":557,"codeLine":570,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nReturns if this instance has not been persisted.\n","title":"isNew","signatures":[{"code":"connection.isNew(instance)","description":"\n\n  Checks that the instance has an [can-connect/base/base.id].\n","params":[{"types":[{"type":"Object","options":[]}],"name":"instance","description":"The instance to test."}],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if the instance has not been persisted.\n\t "}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"instance","description":"The instance to test."},"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if the instance has not been persisted.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
