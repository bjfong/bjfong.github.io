...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Get a single instance from the &quot;data interface&quot;.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L157">source</a></li>
...
<div class="signature">
  ...
  <p>Gets an instance from <a href="../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> and runs the resulting data
through <a href="../constructor.hydrateList.html" title="Makes a list type object given raw data.">hydrateList</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>Data specifying the instance to retrieve.  Normally, this
looks like: <code>{id: 5}</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;List&lt;Instance&gt;&gt;}</code>: <p>An instance that represents the data that was loaded.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>Call <code>.getList()</code> with the parameters that identify the instance
you want to load.  <code>.getList()</code> will return a promise that resolves
to your instance.</p>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/constructor.getList","parent":"can-connect/constructor/constructor.crud","src":{"line":157,"codeLine":186,"path":"node_modules/can-connect/constructor/constructor.js"},"description":"\nGet a single instance from the \"data interface\".\n","title":"getList","signatures":[{"code":"connection.getList(set)","description":"\n\n  Gets an instance from [can-connect/connection.getListData] and runs the resulting data\n  through [can-connect/constructor.hydrateList].\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"Data specifying the instance to retrieve.  Normally, this\nlooks like: `{id: 5}`.\n"}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"List","template":[{"types":[{"type":"Instance"}]}]}]}]}],"description":"An instance that represents the data that was loaded.\n"}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"Data specifying the instance to retrieve.  Normally, this\nlooks like: `{id: 5}`.\n"},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"List","template":[{"types":[{"type":"Instance"}]}]}]}]}],"description":"An instance that represents the data that was loaded.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
