...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/docs/data_interface/getData.md">source</a></li>
...
and Arrays.">can-connect/constructor/constructor</a> calls <code>getData</code>
...
<pre><code class="language-js">connection.getData({id: 1}).then(function(instanceData){
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p>Extensions like <a href="data/url/url.html" title="">can-connect/data/url/url</a> implement <code>getData</code>  but implementing it yourself can be as simple as:</p>
