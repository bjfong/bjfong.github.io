...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/parse/parse.js#L161">source</a></li>
...
representing the instance that will be created.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Object}</code>: <p>The data that should be passed to <a href="../../constructor/constructor.hydrateInstance.html" title="Makes a type object given raw data.">hydrateInstance</a>.</p>
</p>
  </div>
