...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/combine-requests/combine-requests.js#L288">source</a></li>
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        ...
        <p>A <a href="../../can-set.html" title="can-set is a utility for comparing sets that are represented by the parameters commonly passed to service requests.">can-set</a>(https://github.com/canjs/can-set) set object.</p>

      </li>
    
      <li>
        <b>deferred</b> <code>{Deferred}</code>:
        <p>A defferred that can be used to resolve or reject a promise.</p>
...
<script type="text/javascript">
  var docObject = {"src":{"line":288,"codeLine":295,"path":"node_modules/can-connect/data/combine-requests/combine-requests.js"},"type":"typedef","description":"\n","title":"PendingRequest","types":[{"type":"Object","options":[{"name":"set","types":[{"type":"can-set/Set"}],"description":"A [can-set](https://github.com/canjs/can-set) set object."},{"name":"deferred","types":[{"type":"Deferred"}],"description":"A defferred that can be used to resolve or reject a promise.\n"}]}],"name":"can-connect/data/combine-requests.PendingRequest","parent":"can-connect/data/combine-requests.types","pathToRoot":"../../.."};
</script>
</article>
