...
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/data/memory-cache/memory-cache</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/data/memory-cache/memory-cache</h1>
		<div>module</div>
	</div>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/memory-cache/memory-cache.js">source</a></li>
...
of sets.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>data/memory-cache</code> is often used with a caching strategy like <a href="../../fall-through-cache/fall-through-cache.html" title="A fall through cache that checks another cacheConnection.">can-connect/fall-through-cache/fall-through-cache</a> or
<a href="../../cache-requests/cache-requests.html" title="Caches reponse data and uses it to prevent future requests or make future requests smaller.">can-connect/cache-requests/cache-requests</a>.</p>
