	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							...
							title="can-connect/can/ref/ref.Map.Ref.prototype.isPending">
							isPending
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="can-connect/can/ref/ref.Map.Ref.prototype.isRejected">
							isRejected
						</a>
					...
					<li class="
           						...
           						">
						<a class="property"
							href="ref.Map.Ref.prototype.promise.html"
							title="can-connect/can/ref/ref.Map.Ref.prototype.promise">
							promise
						</a>
					...
					<li class="
						...
						<a class="property"
							...
							title="can-connect/can/ref/ref.Map.Ref.prototype.reason">
							reason
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="can-connect/can/ref/ref.Map.Ref.prototype.serialize">
							serialize
						</a>
					...
					<li class="
						...
						<a class="property"
							...
							title="can-connect/can/ref/ref.Map.Ref.prototype.value">
							value
						</a>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/ref/ref.js#L191">source</a></li>
...
<div class="signature">
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>ref</b> <code>{Object|String|Number}</code>: </li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="ref.Map.Ref.html" title="can-connect/can/ref/ref.Map.Ref">Map.Ref</a>}</code>: </p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.type","parent":"can-connect/can/ref/ref.Map.Ref.static","src":{"line":191,"codeLine":200,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\n","title":"type","signatures":[{"code":"Map.Ref.type(ref)","description":"\n","params":[{"types":[{"type":"Object"},{"type":"String"},{"type":"Number"}],"name":"ref","description":""}],"returns":{"types":[{"type":"can-connect/can/ref/ref.Map.Ref"}],"description":"\n "}}],"_curParam":{"types":[{"type":"Object"},{"type":"String"},{"type":"Number"}],"name":"ref","description":""},"_curReturn":{"types":[{"type":"can-connect/can/ref/ref.Map.Ref"}],"description":"\n "},"pathToRoot":"../../../.."};
</script>
</article>
