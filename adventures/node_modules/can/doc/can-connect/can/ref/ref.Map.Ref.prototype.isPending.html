...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/ref/ref.js#L314">source</a></li>
...
<div class="signature">
  ...
  <pre><code>Returns true if the state is not 'resolved' or 'rejected'
</code></pre>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.prototype.isPending","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":314,"codeLine":321,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"","title":"isPending","signatures":[{"code":"ref.isPending","description":"\n\tReturns true if the state is not 'resolved' or 'rejected'","params":[],"returns":{"types":[{"type":"boolean"}],"description":"\n "}}],"_curReturn":{"types":[{"type":"boolean"}],"description":"\n "},"pathToRoot":"../../../.."};
</script>
</article>
