...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/ref/ref.js#L261">source</a></li>
...
<div class="signature">
  ...
  <pre><code>handles the rejection case for the promise
</code></pre>
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/can/ref/ref.Map.Ref.prototype.reason","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":261,"codeLine":268,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"","types":[{"type":"*"}],"title":"reason","signatures":[{"code":"ref.reason","description":"\n\thandles the rejection case for the promise","params":[],"returns":{"types":[{"type":"Object","options":[]}],"description":"error message if the promise is rejected\n\t "}}],"_curReturn":{"types":[{"type":"Object","options":[]}],"description":"error message if the promise is rejected\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
