...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/ref/ref.js#L292">source</a></li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/can/ref/ref.Map.Ref.prototype.isResolved","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":292,"codeLine":300,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"\n","title":"isResolved","signatures":[{"code":"ref.isResolved","description":"\n\tReturns a {boolean}","params":[],"returns":{"types":[{"type":"boolean"}],"description":"\n "}}],"_curReturn":{"types":[{"type":"boolean"}],"description":"\n "},"pathToRoot":"../../../.."};
</script>
</article>
