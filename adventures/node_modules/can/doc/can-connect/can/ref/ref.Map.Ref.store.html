...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/ref/ref.js#L184">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/can/ref/ref.Map.Ref.store","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.static","src":{"line":184,"codeLine":189,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"A WeakReferenceMap that contains instances being created by their `._cid` property.\n","types":[{"type":"can-connect/helpers/weak-reference-map"}],"title":"store","pathToRoot":"../../../.."};
</script>
</article>
