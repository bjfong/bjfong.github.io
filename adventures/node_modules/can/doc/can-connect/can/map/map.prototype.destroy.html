...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Delete's the instance with the connection.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L611">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>map.destroy( [success], [error] )</code>
  </h2>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>success</b> <code>{function}</code>: <p>A function that is called if the destroy is successful.</p>
</li>
        
          <li><b>error</b> <code>{function}</code>: <p>A function that is called if the destroy is rejected.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;Instance&gt;}</code>: <p>A promise that resolves to the instance is successful.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"src":{"line":611,"codeLine":648,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nDelete's the instance with the connection.\n","title":"destroy","name":"can-connect/can/map/map.prototype.destroy","parent":"can-connect/can/map/map.map","signatures":[{"code":"map.destroy( [success], [error] )","description":"\n","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"optional":true,"name":"success","description":"A function that is called if the destroy is successful."},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"optional":true,"name":"error","description":"A function that is called if the destroy is rejected."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Instance"}]}]}],"description":"A promise that resolves to the instance is successful.\n"}}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"optional":true,"name":"error","description":"A function that is called if the destroy is rejected."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Instance"}]}]}],"description":"A promise that resolves to the instance is successful.\n"},"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
