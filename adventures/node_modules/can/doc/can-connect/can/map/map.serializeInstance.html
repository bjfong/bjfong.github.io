...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Calls <code>instance.serialize()</code>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L82">source</a></li>
...
<div class="signature">
  ...
  <p>Simply calls <a href="../../../can-define/map/map.prototype.serialize.html" title="Get a serialized representation of the map instance and its children.">serialize</a> on the underlying map.</p>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/can/map/map.serializeInstance","parent":"can-connect/can/map/map.serializers","src":{"line":82,"codeLine":92,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nCalls `instance.serialize()`.\n","title":"serializeInstance","signatures":[{"code":"connection.serializeInstance( instance )","description":"\n\n  Simply calls [can-define/map/map.prototype.serialize] on the underlying map.\n\t ","params":[]}],"pathToRoot":"../../../.."};
</script>
</article>
