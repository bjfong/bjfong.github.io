...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Returns if the map is currently being saved.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L522">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>map.isSaving()</code>
  </h2>
  <p>Returns <code>true</code> if .save() has been called, but has not resolved yet.</p>
...
<script type="text/javascript">
  var docObject = {"src":{"line":522,"codeLine":534,"path":"node_modules/can-connect/can/map/map.js"},"type":"function","description":"\nReturns if the map is currently being saved.\n","title":"isSaving","name":"can-connect/can/map/map.prototype.isSaving","parent":"can-connect/can/map/map.map","signatures":[{"code":"map.isSaving()","description":"\n\n  Returns `true` if .save() has been called, but has not resolved yet.\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"\n\t "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
