...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Calls <code>list.serialize()</code>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L95">source</a></li>
...
<div class="signature">
  ...
  <p>Simply calls <a href="../../../can-define/list/list.prototype.serialize.html" title="Returns the a serialized version of this list.">serialize</a> on the underlying list.</p>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/can/map/map.serializeList","parent":"can-connect/can/map/map.serializers","src":{"line":95,"codeLine":105,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nCalls `list.serialize()`.\n","title":"serializeList","signatures":[{"code":"connection.serializeList( list )","description":"\n\n  Simply calls [can-define/list/list.prototype.serialize] on the underlying list.\n\t ","params":[]}],"pathToRoot":"../../../.."};
</script>
</article>
