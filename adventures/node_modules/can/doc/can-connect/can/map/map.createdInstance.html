...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Updates the instance with the response from <a href="../../connection.createData.html" title="Creates a new record in the connection.">createData</a>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L280">source</a></li>
...
<div class="signature">
  ...
  <p>Updates the instance with <code>props</code> and dispatches a
&quot;created&quot; event on the map and the map's constructor function.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{Map}</code>: <p>a Map instance</p>
</li>
        
          <li><b>props</b> <code>{Object}</code>: <p>the updated properties</p>
</li>
