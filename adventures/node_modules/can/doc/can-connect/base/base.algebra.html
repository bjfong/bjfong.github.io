    ...
    <code><a href="../../can-set.Algebra.html" title="Perform set logic with an awareness of how certain properties represent a set.">Algebra</a>(<a href="../../can-set.compares.html" title="An object of property names and prop functions.
{
  ...
  <p>A set algebra that is used by
many behaviors to compare the <code>set</code> objects passed to
<a href="../connection.getListData.html" title="Retrieves list of records for the given set.">getListData</a> and <a href="../connection.getList.html" title="">connection.getList</a>. By
default no algebra is provided.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<pre><code>var algebra = new set.Algebra(set.props.range(&quot;start&quot;,&quot;end&quot;));
...
<script type="text/javascript">
  var docObject = {"description":"\n","types":[{"type":"can-set.Algebra","description":"A set algebra that is used by\nmany behaviors to compare the `set` objects passed to\n[can-connect/connection.getListData] and [can-connect/connection.getList]. By\ndefault no algebra is provided.\n"}],"title":"algebra","name":"can-connect/base/base.algebra","type":"property","parent":"can-connect/base/base","comment":" ","pathToRoot":"../../.."};
</script>
</article>
