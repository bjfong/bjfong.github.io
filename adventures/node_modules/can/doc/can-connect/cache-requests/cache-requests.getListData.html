...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Only request data that hasn't already been loaded by <a href="../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/cache-requests/cache-requests.js#L202">source</a></li>
...
<div class="signature">
  ...
  <p>Overwrites a base connection's <code>getListData</code> to use data in the <a href="../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a>
whenever possible.  This works by <a href="../connection.getSets.html" title="Gets the sets that are available in the connection.">getting the stored sets</a> and doing a
<a href="cache-requests.getDiff.html" title="Compares the available set data to the requested data and returns
the data that should be loaded from the cache and the data loaded
from the base connection.">diff</a> to see what should be loaded from the cache
or from the base connection.</p>
<p>With that information, this <code>getListData</code> requests data from the cache and/or the base
connection.  Once it has been recieved, it combines the data with <a href="cache-requests.getUnion.html" title="Returns the union of the cached and needed data.">getUnion</a>.</p>
