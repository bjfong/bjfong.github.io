...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/docs/data_interface/createData.md">source</a></li>
...
instance. A <a href="../can-util/js/cid/cid.html" title="can-util/js/cid/cid">client ID</a> is passed of the instance that is
being created.</p>
<p>The following shows how <a href="constructor/constructor.html" title="Adds the ability to operate on special types instead of plain JavaScript Objects
and Arrays.">can-connect/constructor/constructor</a> calls <code>createData</code>
...
the instance can be retrieved in the <a href="constructor/constructor.cidStore.html" title="A WeakReferenceMap that contains instances being created by their ._cid property.">cidStore</a>.</p>
</li>
...
<p>By default, <a href="constructor/constructor.createdInstance.html" title="Updates the instance being created with the result of connection.createData.">createdInstance</a> only adds the data in <code>createdInstanceData</code> to
...
<a href="constructor/constructor.createdInstance.html" title="Updates the instance being created with the result of connection.createData.">createdInstance</a>.</p>
</p>
  </div>
