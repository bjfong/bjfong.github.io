...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/docs/data_interface/destroyData.md">source</a></li>
...
and Arrays.">can-connect/constructor/constructor</a> calls <code>destroyData</code> and
...
data.</p>
<p>By default, <a href="constructor/constructor.destroyedInstance.html" title="Updates the instance being destroyed with the result of connection.destroyData.">destroyedInstance</a> deletes properties in <code>myInstance</code> that are not in <code>destroyedInstanceData</code>.  To change that behavior, overwrite <a href="constructor/constructor.destroyedInstance.html" title="Updates the instance being destroyed with the result of connection.destroyData.">destroyedInstance</a>.</p>
</p>
  </div>
