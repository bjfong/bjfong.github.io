...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/docs/can-canjs/can-legacy.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"docs/can-canjs/can-legacy.md"},"description":"Former libraries that we still accept patches for, but are not under active development.\n\n","name":"can-legacy","title":"Legacy","type":"page","parent":"canjs","order":4,"comment":" ","pathToRoot":".."};
</script>
</article>
