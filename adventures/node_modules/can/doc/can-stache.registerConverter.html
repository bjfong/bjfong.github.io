...
<head>
	<meta charset="utf-8">
	<title>CanJS - registerConverter</title>
...
<div class="breadcrumb">
	...
	<li><a href="can-stache.registerConverter.html">registerConverter</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>registerConverter</h1>
		<div>function</div>
	</div>
	
  
	<section class="description">
    <p>Register a helper for bidirectional value conversion.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-stache/tree/v3.0.13/docs/registerConverter.md">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>stache.registerConverter(converterName, getterSetter)</code>
  </h2>
  <p>Creates a helper that can do two-way conversion between two
values.  This is especially useful with
<a href="can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">{($two-way)} bindings</a> like:</p>
<pre><code class="language-handlebars">&lt;input {($value)}='numberToString(~age)'/&gt;
</code></pre>
<p>A converter helper provides:</p>
<ul>
...
<p><code>numberToString</code> might converts a number (<code>age</code>)
to a string (<code>value</code>), and the string (<code>value</code>) to a number (<code>age</code>)
as follows:</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>converterName</b> <code>{String}</code>: <p>The name of the converter helper.</p>
</li>
        
          <li><b>getterSetter</b> <code>{<a href="can-stache.getterSetter.html" title="The getterSetter argument passed to registerConverter.">getterSetter</a>}</code>: <p>An object containing get() and set() functions.</p>
</li>
    ...
    <h2>Use</h2>
<blockquote>
<p><strong>NOTE</strong>: Before creating your own converter, you may want to look at what’s provided by <a href="can-stache-converters.html" title="Provides a set of converters useful for two-way binding with form elements such as &lt;input&gt; and &lt;select&gt;.">can-stache-converters</a>.</p>
</blockquote>
<p>These helpers are useful for avoiding creating <a href="can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> getters and setters that do similar conversions on the view model.  Instead,
...
must be converted to a string.</p>
<p>That being said, the following is a richer example of a converter,
but one that should probably be part of a view model.</p>
<pre><code class="language-handlebars">&lt;input {($value)}='fullName(~first, ~last)'/&gt;
</code></pre>
<p>The following might converts both ways <code>first</code> and <code>last</code> to <code>value</code>.</p>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-stache/docs/registerConverter.md"},"description":"Register a helper for bidirectional value conversion. \n","title":"registerConverter","name":"can-stache.registerConverter","type":"function","parent":"can-stache.static","signatures":[{"code":"stache.registerConverter(converterName, getterSetter)","description":"\n\nCreates a helper that can do two-way conversion between two\nvalues.  This is especially useful with\n[can-stache-bindings.twoWay {($two-way)} bindings] like:\n\n```handlebars\n<input {($value)}='numberToString(~age)'/>\n```\n\nA converter helper provides:\n\n - a `get` method that returns the value\n  of the `left` value given the arguments passed on the `right`.\n - a `set` method that updates one or multiple of the `right` arguments\n   computes given a new `left` value.\n\n`numberToString` might converts a number (`age`)\nto a string (`value`), and the string (`value`) to a number (`age`)\nas follows:\n\n\n```js\nstache.registerConverter(\"numberToString\", {\n get: function(fooCompute) {\n \treturn \"\" + fooCompute();\n },\n set: function(newVal, fooCompute) {\n \tfooCompute(+newVal);\n }\n});\n```\n","params":[{"types":[{"type":"String"}],"name":"converterName","description":"The name of the converter helper."},{"types":[{"type":"can-stache.getterSetter"}],"name":"getterSetter","description":"An object containing get() and set() functions.\n"}]}],"_curParam":{"types":[{"type":"can-stache.getterSetter"}],"name":"getterSetter","description":"An object containing get() and set() functions.\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
