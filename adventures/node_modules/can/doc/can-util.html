...
<section class="title-footer">
		...
		<ul class="title-social">
			<li>
				<a class="npm-button" href="https://www.npmjs.com/package/can-util">
					<img src="https://img.shields.io/badge/npm%20package-3.0.13-brightgreen.svg" alt="npm package badge" />
				</a>
			</li>
			<li>
			<a class="github-button nav-social" href="https://github.com/canjs/can-util"
				data-count-href="/canjs/can-util/stargazers"
				data-count-api="/repos/canjs/can-util#stargazers_count">Star</a>
	  	</li>
		</ul>
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/doc/can-util.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-util/doc/can-util.md"},"description":"\nA set of utilities.\n","name":"can-util","type":"page","parent":"can-infrastructure","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"bit-docs":{"dependencies":{"bit-docs-dev":"^0.0.3","bit-docs-generate-readme":"^0.0.8","bit-docs-glob-finder":"^0.0.5","bit-docs-js":"^0.0.3"},"glob":{"ignore":["node_modules/**/*","**/*{-,_,}{test,qunit}{s,}.js"],"pattern":"**/*.{js,md}"},"parent":"can-util","readme":{"apis":"./doc/apis.json"}},"bugs":{"url":"https://github.com/canjs/can-util/issues"},"dependencies":{},"description":"Common utilities for CanJS projects","devDependencies":{"bit-docs":"0.0.7","can-event":"^3.0.0-pre.13","cssify":"^1.0.2","done-serve":"^0.2.4","donejs-cli":"^0.9.5","generator-donejs":"^0.9.0","jshint":"^2.9.1","mocha":"^3.0.2","mocha-qunit-ui":"^0.1.2","steal":"^0.16.0","steal-qunit":"^0.1.1","steal-tools":"^0.16.0","testee":"^0.2.4"},"directories":{},"dist":{"shasum":"f556b8c6b43d2d5e1328690b29b297e8673991a3","tarball":"https://registry.npmjs.org/can-util/-/can-util-3.0.13.tgz"},"gitHead":"98eb0d9a26dbe4613786e59ddba137cfc20e5bc1","homepage":"http://canjs.com","keywords":["canjs","canjs-plugin","donejs"],"main":"can-util","maintainers":[{"email":"brad@bitovi.com","name":"bmomberger-bitovi"},{"email":"daff@neyeon.de","name":"daffl"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"matthew@matthewphillips.info","name":"matthewp"},{"email":"kphillips86@gmail.com","name":"phillipskevin"},{"email":"john@ardea.io","name":"sinjhin"}],"name":"can-util","optionalDependencies":{},"repository":{"type":"git","url":"git://github.com/canjs/can-util.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"bit-docs","jshint":"jshint dom/. js/. *.js --config","mocha":"mocha --reporter dot --ui mocha-qunit-ui js/tests","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish","test":"npm run jshint && npm run mocha && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"system":{"npmAlgorithm":"flat"},"version":"3.0.13"},"pathToRoot":".."};
</script>
</article>
