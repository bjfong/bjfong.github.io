...
<head>
	<meta charset="utf-8">
	<title>CanJS - setImmediate</title>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/set-immediate/set-immediate.js#L2">source</a></li>
...
<script type="text/javascript">
  var docObject = {"type":"module","name":"can-util/js/set-immediate/set-immediate","parent":"can-util/js","src":{"line":2,"codeLine":10,"path":"node_modules/can-util/js/set-immediate/set-immediate.js"},"description":"","title":"setImmediate","signatures":[{"code":"setImmediate(function())","description":"","params":[{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"cb","description":"\n\nPolyfill for setImmediate() if it doesn't exist in the global context\n"}]}],"_curParam":{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"cb","description":"\n\nPolyfill for setImmediate() if it doesn't exist in the global context\n"},"pathToRoot":"../../../.."};
</script>
</article>
