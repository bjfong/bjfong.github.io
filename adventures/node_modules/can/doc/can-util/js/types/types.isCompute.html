...
<!--####################################################################
	...
	@function can-util/js/types/types.isCompute
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
	<title>CanJS - isCompute</title>
...
<div class="breadcrumb">
	...
	<li><a href="types.isCompute.html">isCompute</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/types/types.js#L91">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>types.isCompute(obj)</code>
  </h2>
  <p>Returns true if <code>obj</code> is a <a href="../../../can-compute.html" title="Create an observable value.">can-compute</a>.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if the object is a <a href="../../../can-compute.html" title="Create an observable value.">can-compute</a>.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-util/js/types/types.isCompute","parent":"can-util/js/types/types","src":{"line":91,"codeLine":98,"path":"node_modules/can-util/js/types/types.js"},"description":"","title":"isCompute","signatures":[{"code":"types.isCompute(obj)","description":"\n  Returns true if `obj` is a [can-compute].\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if the object is a [can-compute].\n "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if the object is a [can-compute].\n "},"pathToRoot":"../../../.."};
</script>
</article>
