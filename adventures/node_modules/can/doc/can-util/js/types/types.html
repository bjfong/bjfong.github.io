...
<head>
	<meta charset="utf-8">
	<title>CanJS - can-util/js/types/types</title>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/types/types.js">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>can-util/js/types/types</code> exports an object with placeholder functions that
can be used to provide default types or test if something is of a certain type.</p>
<p>This is where the sausage of loose coupling modules takes place.
Modules that provide a type will overwrite one or multiple of these functions so
they take into account the new type.</p>
<p>For example, <code>can-define/map/map</code> might overwrite <code>isMapLike</code> to return true
if the object is an instance of Map:</p>
<pre><code class="language-js">var types = require(&quot;can-util/js/types/types&quot;);
...
<script type="text/javascript">
  var docObject = {"name":"can-util/js/types/types","type":"module","parent":"can-util/js","src":{"line":0,"codeLine":29,"path":"node_modules/can-util/js/types/types.js"},"description":"A stateful container for CanJS type information. \n","title":"","types":[{"type":"Object","options":[]}],"comment":" ","pathToRoot":"../../../.."};
</script>
</article>
