...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/fall-through-cache/fall-through-cache.js#L219">source</a></li>
...
<div class="signature">
  ...
  <p>Checks the <a href="../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a> for <code>params</code>'s data.</p>
<p>If the cache connection has data, the cached data is returned. Prior to
returning the data, the <a href="../constructor/constructor.hydrateInstance.html" title="Makes a type object given raw data.">hydrateInstance</a> method
