...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/helpers/weak-reference-map.js#L56">source</a></li>
...
when a value should be managed by something, typically the <a href="../constructor/store/store.html" title="Supports saving and retrieving lists and instances in a store.">can-connect/constructor/store/store</a>.</p>
