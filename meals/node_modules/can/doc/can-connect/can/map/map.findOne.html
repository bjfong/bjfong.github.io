...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Alias of <a href="map.get.html" title="Gets an instance of the map type.">get</a>. You should use <code>.get()</code>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L459">source</a></li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/can/map/map.findOne","params":[{"name":"base","types":[{"type":"*"}]},{"name":"connection","types":[{"type":"*"}]}],"parent":"can-connect/can/map/map.map-static","src":{"line":459,"codeLine":466,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nAlias of [can-connect/can/map/map.get]. You should use `.get()`.\n","title":"findOne","hide":true,"pathToRoot":"../../../.."};
</script>
</article>
