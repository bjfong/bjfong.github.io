...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Returns a unique identifier value for an instance.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L41">source</a></li>
...
<div class="signature">
  ...
  <p>Reads the <a href="../../base/base.algebra.html" title="">algebra</a>'s id so that it's observable unless
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: </li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/can/map/map.id","parent":"can-connect/can/map/map.identifiers","src":{"line":41,"codeLine":57,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nReturns a unique identifier value for an instance.\n","title":"id","signatures":[{"code":"connection.id( instance )","description":"\n\n  Reads the [can-connect/base/base.algebra]'s id so that it's observable unless\n  the id is being read as part of the map being bound or\n  unbound.\n","params":[{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"\n"}],"returns":{"types":[{"type":"*"}],"description":"\n\t "}}],"_curParam":{"types":[{"type":"can-connect/Instance"}],"name":"instance","description":"\n"},"_curReturn":{"types":[{"type":"*"}],"description":"\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
