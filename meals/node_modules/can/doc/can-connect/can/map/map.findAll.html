...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Alias of <a href="map.getList.html" title="Gets a list of instances of the map type.">getList</a>. You should use <code>.getList()</code>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.js#L405">source</a></li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/can/map/map.findAll","params":[{"name":"base","types":[{"type":"*"}]},{"name":"connection","types":[{"type":"*"}]}],"parent":"can-connect/can/map/map.map-static","src":{"line":405,"codeLine":412,"path":"node_modules/can-connect/can/map/map.js"},"description":"\nAlias of [can-connect/can/map/map.getList]. You should use `.getList()`.\n","title":"findAll","hide":true,"pathToRoot":"../../../.."};
</script>
</article>
