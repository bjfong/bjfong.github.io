...
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/can/map/map</title>
  ...
  <li>
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							href="map.get.html"
							title="Gets an instance of the map type.">
							get
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Gets a list of instances of the map type.">
							getList
						</a>
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							...
							title="Delete&#x27;s the instance with the connection.">
							destroy
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Returns if the map is currently being destroyed.">
							isDestroying
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Returns if the map has not been persisted.">
							isNew
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Returns if the map is currently being saved.">
							isSaving
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Persists the map&#x27;s data to the connection.">
							save
						</a>
	...
	<ul>
					...
					<li class="
						...
						<a class="property"
							href="map._List.html"
							title="Specify what type of CanList should be hydrated.">
							List
						</a>
					...
					<li class="
						...
						<a class="property"
							href="map._Map.html"
							title="Specify what type of Map should be hydrated.">
							Map
						</a>
					...
					<li class="
						...
						<a class="function"
							href="map.list.html"
							title="Creates a List instance given raw data.">
							list
						</a>
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							...
							title="Calls instance.serialize().">
							serializeInstance
						</a>
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							href="map.id.html"
							title="Returns a unique identifier value for an instance.">
							id
						</a>
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							...
							title="Updates the instance with the response from connection.createData.">
							createdInstance
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Updates the instance with the response from connection.destroyData.">
							destroyedInstance
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Updates the instance with the response from connection.updateData.">
							updatedInstance
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Updates a list with response data.">
							updatedList
						</a>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/can/map/map</h1>
		<div>module</div>
	</div>
	
  
	<section class="description">
    <p>Make a connection use a <a href="../../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> type.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/map/map.md">source</a></li>
...
<div class="signature">
  ...
  <p>Implements the hydrators, serializers, identifiers, and instance
callback interfaces of <a href="../../constructor/constructor.html" title="Adds the ability to operate on special types instead of plain JavaScript Objects
and Arrays.">can-connect/constructor/constructor</a> so they work with a <a href="../../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> and <a href="../../../can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>.
Adds static methods like <a href="map.getList.html" title="Gets a list of instances of the map type.">getList</a> and prototype methods
like <a href="map.prototype.isDestroying.html" title="Returns if the map is currently being destroyed.">isDestroying</a> to the Map type that make use of the connection's
methods.</p>
    ...
    <section class="body">
    <h2>Use</h2>
<p>The <code>can-connect/can/map/map</code> behavior make a connection use instances of a <a href="../../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a> and
<a href="../../../can-define/list/list.html" title="Create observable lists.">can-define/list/list</a>.  It also adds methods to the <a href="../../../can-define/map/map.html" title="Create observable objects.">can-define/map/map</a>
that use the connection for retrieving, creating, updating, and destroying Map instances.</p>
<p>To use <code>can-connect/can/map/map</code>, first create a Map and List constructor function:</p>
...
<p>Next, pass the Map and List constructor functions to <code>connect</code> as options. The following
creates a connection that connects <code>Todo</code> and <code>TodoList</code> to a restful URL:</p>
...
<p>Now the connection can be used to CRUD <code>Todo</code> and <code>TodoList</code>s:</p>
...
<p>However, because <code>can/map</code> adds methods to the <code>Map</code> option, you can use <code>Todo</code> directly to
retrieve <code>Todo</code> and <code>TodoList</code>s:</p>
<pre><code class="language-js">Todo.getList({}).then(function(todos){ ... });
Todo.get({}).then(function(todo){ ... });
</code></pre>
<p>You can also create, update, and <a href="map.prototype.destroy.html" title="Delete's the instance with the connection.">destroy</a> todo instances. Notice
that <a href="map.prototype.save.html" title="Persists the map's data to the connection.">save</a> is used to create
and update:</p>
<pre><code class="language-js">new Todo({name: &quot;dishes&quot;}).save().then(function(todo){
  todo.set({
      name: &quot;Do the dishes&quot;
    })
    .save()
...
<a href="map.prototype.isSaving.html" title="Returns if the map is currently being saved.">saved</a> or <a href="map.prototype.isDestroying.html" title="Returns if the map is currently being destroyed.">destroyed</a>:</p>
