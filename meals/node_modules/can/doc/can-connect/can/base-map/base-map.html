...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/base-map/base-map.md">source</a></li>
...
<p>As, <a href="../map/map.html" title="Make a connection use a map type.">can-connect/can/map/map</a> adds CRUD methods to the <code>Map</code> option, you can use those to create,
