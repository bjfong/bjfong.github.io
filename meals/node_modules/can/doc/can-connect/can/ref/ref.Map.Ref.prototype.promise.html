...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/can/ref/ref.js#L212">source</a></li>
...
<div class="signature">
  ...
  <pre><code>returns a promise if it has already been resolved, if not, returns a new promise
</code></pre>
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/can/ref/ref.Map.Ref.prototype.promise","type":"property","parent":"can-connect/can/ref/ref.Map.Ref.prototype","src":{"line":212,"codeLine":219,"path":"node_modules/can-connect/can/ref/ref.js"},"description":"","types":[{"type":"Promise"}],"title":"promise","signatures":[{"code":"ref.promise","description":"\n\treturns a promise if it has already been resolved, if not, returns a new promise","params":[],"returns":{"types":[{"type":"Promise"}],"description":"\n\t "}}],"_curReturn":{"types":[{"type":"Promise"}],"description":"\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
