...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/docs/data_interface/updateData.md">source</a></li>
...
and Arrays.">can-connect/constructor/constructor</a> calls <code>updateData</code>
...
<p>By default, <a href="constructor/constructor.updatedInstance.html" title="Updates the instance being updated with the result of connection.updateData.">updatedInstance</a> deletes properties in <code>myInstance</code> that are not in <code>updatedInstanceData</code>.  To change that behavior, overwrite <a href="constructor/constructor.updatedInstance.html" title="Updates the instance being updated with the result of connection.updateData.">updatedInstance</a>.</p>
</p>
  </div>
