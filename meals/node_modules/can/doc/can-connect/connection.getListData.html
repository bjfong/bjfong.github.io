...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/docs/data_interface/getListData.md">source</a></li>
...
<pre><code class="language-js">{
  ...
  count: 1000
    ...
    <section class="body">
    <h2>Use</h2>
<p>Extensions like <a href="data/url/url.html" title="">can-connect/data/url/url</a> make it easy to implement <code>getListData</code>, but it can be as simple as:</p>
