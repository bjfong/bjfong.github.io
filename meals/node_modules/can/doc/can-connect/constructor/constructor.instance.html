...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Returns the typed form of the raw data.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L635">source</a></li>
...
<div class="signature">
  ...
  <p>Takes raw data and runs it through <a href="constructor.hydrateInstance.html" title="Makes a type object given raw data.">hydrateInstance</a>.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>The typed instance.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>If you have a special type with helper functions you'd like to have available,
you can convert raw data to that type in <code>instance</code>.  The following makes it so
<a href="constructor.get.html" title="Get a single instance from the &quot;data interface&quot;.">.get</a> resolves to objects with a <code>complete</code> method.</p>
<pre><code>Todo = function(props){
...
<p>This allows:</p>
<pre><code>todosConnection.get({id: 5}).then(function(todo){
  todo.complete();
});
</code></pre>
...
<script type="text/javascript">
  var docObject = {"src":{"line":635,"codeLine":687,"path":"node_modules/can-connect/constructor/constructor.js"},"type":"property","description":"\nReturns the typed form of the raw data.\n","title":"instance","name":"can-connect/constructor/constructor.instance","parent":"can-connect/constructor/constructor.hydrators","signatures":[{"code":"connection.instance( props )","description":"\n\n  Takes raw data and runs it through [can-connect/constructor/constructor.hydrateInstance].\n","params":[{"types":[{"type":"Object","options":[]}],"name":"props","description":"\n"}],"returns":{"types":[{"type":"can-connect/Instance"}],"description":"The typed instance.\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"props","description":"\n"},"_curReturn":{"types":[{"type":"can-connect/Instance"}],"description":"The typed instance.\n"},"comment":" ","pathToRoot":"../../.."};
</script>
</article>
