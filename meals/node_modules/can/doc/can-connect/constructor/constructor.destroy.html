...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Destroys an instance using the underlying data interface.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/constructor.js#L375">source</a></li>
...
<div class="signature">
  ...
  <p>To destroy an instance, its <a href="constructor.serializeInstance.html" title="Returns the serialized form of an instance.">serialized data</a> is passed to
<a href="../connection.destroyData.html" title="Destroys a record in the collection.">destroyData</a>. If <code>destroyData</code>'s promise resolves to anything other than <code>undefined</code>,
<a href="constructor.destroyedInstance.html" title="Updates the instance being destroyed with the result of connection.destroyData.">destroyedInstance</a> is called.</p>
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p>To use <code>destroy</code>, create a connection, then retrieve an instance, and call <code>.destroy()</code> with it.</p>
...
<p>This will DELETE to <code>/todos/5</code> with the <code>todo</code> data.  The server response data
might look something like:</p>
<pre><code>{}
</code></pre>
<p>This data will be passed to <a href="constructor.destroyedInstance.html" title="Updates the instance being destroyed with the result of connection.destroyData.">destroyedInstance</a>.</p>
