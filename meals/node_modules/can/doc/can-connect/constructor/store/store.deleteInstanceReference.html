...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Removes a reference to an instance by <a href="../../base/base.id.html" title="Uniquely identify an instance or raw instance data.">id</a> so it can be garbage collected.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L247">source</a></li>
...
<div class="signature">
  ...
  <p>Decrements the number of references to an instance in the <a href="store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a>.
Removes the instance if there are no longer any references.</p>
  ...
  <div class="parameters">
    ...
    <section class="body">
    <h2>Use</h2>
<p><code>deleteInstanceReference</code> is called to remove references to instances in
the <a href="store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a> so the instances maybe garbage
collected.  It's usually called when the application or some part of the application no
longer is interested in an instance.</p>
<p><a href="store.addInstanceReference.html" title="Adds a reference to an instance so it can be easily looked up.">addInstanceReference</a> has an example of adding
an instance to the store.  The following continues that example to remove
the <code>originalTodo</code> from the store:</p>
