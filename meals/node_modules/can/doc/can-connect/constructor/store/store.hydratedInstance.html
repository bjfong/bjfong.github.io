...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Called when <a href="store.hydrateInstance.html" title="Returns a instance given raw data.">hydrateInstance</a> is called and a new instance is created.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L389">source</a></li>
...
<div class="signature">
  ...
  <p>If there are pending requests, the instance is kept in the <a href="store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{<a href="../../Instance.html" title="An instance of some JavaScript type.">Instance</a>}</code>: <p>The hydrated instance.</p>
</li>
