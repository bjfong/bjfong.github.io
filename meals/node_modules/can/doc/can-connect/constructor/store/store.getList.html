...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Overwrites <a href="../../connection.getList.html" title="">connection.getList</a> so any
<a href="store.hydrateInstance.html" title="Returns a instance given raw data.">hydrated instances</a> or <a href="store.hydrateList.html" title="Returns a list given raw data.">hydrated lists</a>
are kept in the store until the response resolves.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L499">source</a></li>
...
<div class="signature">
  ...
  <p>Increments the request counter so these instances will be stored
and then decrements it after the request is complete.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>Params used to specify which list to retrieve.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Promise&lt;instance&gt;}</code>: <p>The promise returned by the base connection's <a href="../../connection.getList.html" title="">connection.getList</a>.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/store/store.getList","parent":"can-connect/constructor/store/store.crud","src":{"line":499,"codeLine":516,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nOverwrites [can-connect/connection.getList] so any\n[can-connect/constructor/store/store.hydrateInstance hydrated instances] or [can-connect/constructor/store/store.hydrateList hydrated lists]\nare kept in the store until the response resolves.\n","title":"getList","signatures":[{"code":"connection.getList( set )","description":"\n\n  Increments the request counter so these instances will be stored\n  and then decrements it after the request is complete.\n\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"Params used to specify which list to retrieve."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"instance"}]}]}],"description":"The promise returned by the base connection's [can-connect/connection.getList].\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"Params used to specify which list to retrieve."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"instance"}]}]}],"description":"The promise returned by the base connection's [can-connect/connection.getList].\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
