...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Returns a list given raw data.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L469">source</a></li>
...
<div class="signature">
  ...
  <p>Overwrites the base <code>hydrateList</code> so that if a matching list is
in the <a href="store.listStore.html" title="A store of lists mapped by base.listSet.">listStore</a>, that list will
be <a href="../constructor.updatedList.html" title="Updates a list with new data.">updated</a> with <code>listData</code> and returned.
If there isn't a matching list, the base <code>hydrateList</code> will be called.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>listData</b> <code>{<a href="../../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>List data to hyrate into a list type.</p>
</li>
        
          <li><b>set</b> <code>{<a href="../../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The set that represents the data in <code>listData</code>.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{List}</code>: <p>A list from either the store or a newly created instance.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/store/store.hydrateList","parent":"can-connect/constructor/store/store.hydrators","src":{"line":469,"codeLine":486,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nReturns a list given raw data.\n","title":"hydrateList","signatures":[{"code":"connection.hydrateList( listData, set )","description":"\n\n  Overwrites the base `hydrateList` so that if a matching list is\n  in the [can-connect/constructor/store/store.listStore], that list will\n  be [can-connect/constructor/constructor.updatedList updated] with `listData` and returned.\n  If there isn't a matching list, the base `hydrateList` will be called.\n","params":[{"types":[{"type":"can-connect.listData"}],"name":"listData","description":"List data to hyrate into a list type."},{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set that represents the data in `listData`."}],"returns":{"types":[{"type":"List"}],"description":"A list from either the store or a newly created instance.\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set that represents the data in `listData`."},"_curReturn":{"types":[{"type":"List"}],"description":"A list from either the store or a newly created instance.\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
