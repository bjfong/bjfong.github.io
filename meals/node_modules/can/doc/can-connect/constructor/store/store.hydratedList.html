...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Called whenever <a href="store.hydrateList.html" title="Returns a list given raw data.">hydrateList</a> is called with the hydration result.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/constructor/store/store.js#L442">source</a></li>
...
<div class="signature">
  ...
  <p>If there are pending requests, the list is kept in the <a href="store.listStore.html" title="A store of lists mapped by base.listSet.">listStore</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>list</b> <code>{<a href="../../../can-connect.List.html" title="A list type.">List</a>}</code>: <p>The hydrated list.</p>
</li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/constructor/store/store.hydratedList","parent":"can-connect/constructor/store/store.hydrators","src":{"line":442,"codeLine":456,"path":"node_modules/can-connect/constructor/store/store.js"},"description":"\nCalled whenever [can-connect/constructor/store/store.hydrateList] is called with the hydration result.\n","title":"hydratedList","signatures":[{"code":"hydratedList(list)","description":"\n\n  If there are pending requests, the list is kept in the [can-connect/constructor/store/store.listStore].\n","params":[{"types":[{"type":"can-connect.List"}],"name":"list","description":"The hydrated list.\n\n\n\t "}]}],"_curParam":{"types":[{"type":"can-connect.List"}],"name":"list","description":"The hydrated list.\n\n\n\t "},"pathToRoot":"../../../.."};
</script>
</article>
