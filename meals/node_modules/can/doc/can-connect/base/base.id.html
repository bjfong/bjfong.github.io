	...
	<ul>
					...
					<li class="
						...
						<a class="property"
							...
							title="A connection used for caching.">
							cacheConnection
						</a>
					...
					<li class="
						...
						<a class="function"
							...
							title="Uniquely identify the set a list represents.">
							listSet
						</a>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/base/base.js#L27">source</a></li>
...
<div class="signature">
  ...
  <p>Returns the <a href="base.idProp.html" title="">idProp</a> if it exists, otherwise the <a href="base.algebra.html" title="">algebra</a>'s
id values, otherwise the <code>id</code> property.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>instance</b> <code>{Instance|Object}</code>: <p>The instance or raw <code>props</code> for an instance.</p>
</li>
  ...
  <div class="returns">
    ...
    <section class="body">
    <h2>Use</h2>
<p>Many extensions, such as the <a href="../constructor/store/store.html" title="Supports saving and retrieving lists and instances in a store.">can-connect/constructor/store/store</a>, need
to have a unique identifier for an instance or instance data.  The
<code>connection.id</code> method should return that.</p>
<p>Typically, an item's <code>id</code> is a simply propertly value on the object.
For example, <code>todo</code> data might look like:</p>
<pre><code class="language-js">{_id: 5, name: &quot;do the dishes&quot;}
</code></pre>
<p>In this case, <a href="base.algebra.html" title="">algebra</a>'s <code>id</code> comparator should be set to
&quot;_id&quot; like:</p>
...
connection might be represented by two properties, the <code>studentId</code> and the
<code>classId</code>.  For this kind of setup, you can provide your own id function as
follows:</p>
<pre><code class="language-js">var classAssignmentConnection = connect(['data-url'],{
