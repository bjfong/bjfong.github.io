...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/base/base.js#L103">source</a></li>
...
<section class='warnings'>
    ...
    <div class='deprecated warning'>
      ...
      <div class='signature-wrapper'>
        <p>Instead of specifying the idProp it should be
set on the algebra passed to the connection.</p>
...
<div class="signature">
  ...
  <p>The name of the property that uniquely identifies
an instance.  Defaults to <code>&quot;id&quot;</code>.</p>
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/base/base.idProp","type":"property","parent":"can-connect/base/base","src":{"line":103,"codeLine":128,"path":"node_modules/can-connect/base/base.js"},"description":"\n","types":[{"type":"String","description":"The name of the property that uniquely identifies\nan instance.  Defaults to `\"id\"`.\n"}],"title":"idProp","deprecated":[{"version":"0.5.3","description":"Instead of specifying the idProp it should be\nset on the algebra passed to the connection.\n\nSpecifies the property that uniquely identifies an instance.\n"}],"comment":" ","pathToRoot":"../../.."};
</script>
</article>
