...
<!--####################################################################
	...
	@function can-connect/data/combine-requests.getSubset
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
are called.">
	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							...
							title="Tries to combine requests using set logic.">
							getListData
						</a>
	...
	<ul>
					...
					<li class="current
           						...
           						expanded">
						<a class="function"
							href="combine-requests.getSubset.html"
							title="Return the items that belong to an initial request.">
							getSubset
						</a>
...
<div class="breadcrumb">
	...
	<li><a href="combine-requests.getSubset.html">getSubset</a></li>
  ...
  <section class="title">
    ...
    <p>Return the items that belong to an initial request.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/combine-requests/combine-requests.js#L176">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>connection.getSubset( set, unionSet, data )</code>
  </h2>
  <p>This implementation uses <a href="../../can-set.Algebra.prototype.getSubset.html" title="">getSubset</a> on the <a href="../base/base.algebra.html" title="">algebra</a>.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>the subset initially requested</p>
</li>
        
          <li><b>unionSet</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>the combined set that was actually requested</p>
</li>
        
          <li><b>data</b> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>the data from the combined set</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>the data that belongs to <code>set</code></p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/data/combine-requests.getSubset","parent":"can-connect/data/combine-requests.algebra","src":{"line":176,"codeLine":191,"path":"node_modules/can-connect/data/combine-requests/combine-requests.js"},"description":"\nReturn the items that belong to an initial request.\n","title":"getSubset","signatures":[{"code":"connection.getSubset( set, unionSet, data )","description":"\n\n  This implementation uses [can-set.Algebra.prototype.getSubset] on the [can-connect/base/base.algebra].\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"the subset initially requested"},{"types":[{"type":"can-set/Set"}],"name":"unionSet","description":"the combined set that was actually requested"},{"types":[{"type":"can-connect.listData"}],"name":"data","description":"the data from the combined set"}],"returns":{"types":[{"type":"can-connect.listData"}],"description":"the data that belongs to `set`\n\t "}}],"_curParam":{"types":[{"type":"can-connect.listData"}],"name":"data","description":"the data from the combined set"},"_curReturn":{"types":[{"type":"can-connect.listData"}],"description":"the data that belongs to `set`\n\t "},"pathToRoot":"../../.."};
</script>
</article>
