...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/worker/worker.md">source</a></li>
...
<p>The following creates a connection that does the work of <a href="../../cache-requests/cache-requests.html" title="Caches reponse data and uses it to prevent future requests or make future requests smaller.">can-connect/cache-requests/cache-requests</a>,
<a href="../url/url.html" title="">can-connect/data/url/url</a>, and <a href="../memory-cache/memory-cache.html" title="Saves raw data in JavaScript memory that disappears when the page refreshes.">can-connect/data/memory-cache/memory-cache</a> in a worker thread.</p>
