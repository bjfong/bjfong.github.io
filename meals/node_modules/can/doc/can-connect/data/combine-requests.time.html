...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/combine-requests/combine-requests.js#L194">source</a></li>
...
<div class="signature">
  ...
  <p>Defaults to <code>1</code> which means that only requests made within the same
...
are made.  Generally speaking, there's no good reason to increase the amount of time.</p>
<pre><code>connect([
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/data/combine-requests.time","type":"property","parent":"can-connect/data/combine-requests.options","src":{"line":194,"codeLine":214,"path":"node_modules/can-connect/data/combine-requests/combine-requests.js"},"description":"\nSpecifies the amount of time to wait to combine requests.\n","types":[{"type":"Number","description":"Defaults to `1` which means that only requests made within the same\n\"thread of execution\" will be combined.  Increasing this number will mean\nthat requests are going to be delayed that length of time in case other requests\nare made.  Generally speaking, there's no good reason to increase the amount of time.\n\n```\nconnect([\n  require(\"can-connect/data/combine-requests/combine-requests\"),\n  ...\n],{\n  time: 100\n})\n```\n\t "}],"title":"time","pathToRoot":"../../.."};
</script>
</article>
