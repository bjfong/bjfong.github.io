...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Tries to combine requests using set logic.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/combine-requests/combine-requests.js#L215">source</a></li>
...
<div class="signature">
  ...
  <p>Collects the sets for calls to <code>getListData</code> for
...
to take the <a href="https://github.com/canjs/can-set#setunion">union</a> of those sets. It
...
<a href="../../can-set.Algebra.prototype.getSubset.html" title="">getSubset</a> of the unioned set data.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The set used to request data.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="../../can-connect.listData.html" title="The data format used to create typed lists.">ListData</a>}</code>: <p>The data for the requested set of data.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/data/combine-requests.getListData","parent":"can-connect/data/combine-requests.data-methods","src":{"line":215,"codeLine":233,"path":"node_modules/can-connect/data/combine-requests/combine-requests.js"},"description":"\nTries to combine requests using set logic.\n","title":"getListData","signatures":[{"code":"connection.getListData( set )","description":"\n\n  Collects the sets for calls to `getListData` for\n  some [can-connect/data/combine-requests.time].  Once that time has expired, it tries\n  to take the [union](https://github.com/canjs/can-set#setunion) of those sets. It\n  makes requests with those unioned sets. Once the unioned set data has returned,\n  the original requests rae satisified by taking\n  [can-set.Algebra.prototype.getSubset] of the unioned set data.\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set used to request data."}],"returns":{"types":[{"type":"can-connect.listData"}],"description":"The data for the requested set of data.\n\t "}}],"_curParam":{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set used to request data."},"_curReturn":{"types":[{"type":"can-connect.listData"}],"description":"The data for the requested set of data.\n\t "},"pathToRoot":"../../.."};
</script>
</article>
