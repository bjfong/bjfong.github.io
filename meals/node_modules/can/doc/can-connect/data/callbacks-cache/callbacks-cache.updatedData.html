...
of <a href="../../connection.updateData.html" title="Updates a record in the collection.">updateData</a>. Calls <code>updateData</code> on the <a href="../../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/callbacks-cache/callbacks-cache.js#L27">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/data/callbacks-cache/callbacks-cache.updatedData","type":"function","parent":"can-connect/data/callbacks-cache/callbacks-cache","src":{"line":27,"codeLine":34,"path":"node_modules/can-connect/data/callbacks-cache/callbacks-cache.js"},"description":"\nCalled with the resolved response data\nof [can-connect/connection.updateData]. Calls `updateData` on the [can-connect/base/base.cacheConnection].\n","title":"updatedData","pathToRoot":"../../../.."};
</script>
</article>
