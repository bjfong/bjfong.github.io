...
of <a href="../../connection.createData.html" title="Creates a new record in the connection.">createData</a>. Calls <code>createData</code> on the <a href="../../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a>.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/data/callbacks-cache/callbacks-cache.js#L19">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-connect/data/callbacks-cache/callbacks-cache.createdData","type":"function","parent":"can-connect/data/callbacks-cache/callbacks-cache","src":{"line":19,"codeLine":26,"path":"node_modules/can-connect/data/callbacks-cache/callbacks-cache.js"},"description":"\nCalled with the resolved response data\nof [can-connect/connection.createData]. Calls `createData` on the [can-connect/base/base.cacheConnection].\n","title":"createdData","pathToRoot":"../../../.."};
</script>
</article>
