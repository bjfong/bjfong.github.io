...
<head>
	<meta charset="utf-8">
	<title>CanJS - can-connect/real-time/real-time</title>
...
<div class="breadcrumb">
  ...
  <section class="title">
	<div class="page-type">
		<h1>can-connect/real-time/real-time</h1>
		<div>module</div>
	</div>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/real-time/real-time.js">source</a></li>
...
of the <a href="../base/base.listSet.html" title="Uniquely identify the set a list represents.">listSet</a>.  The item is inserted using <a href="../../can-set.Algebra.prototype.index.html" title="">index</a>.</p>
...
<p>It then adds those <code>todos</code> to the <a href="../constructor/store/store.listStore.html" title="A store of lists mapped by base.listSet.">listStore</a> so
...
the todo in the <a href="../constructor/store/store.instanceStore.html" title="A store of instances mapped by base.id.">instanceStore</a> with the
following:</p>
