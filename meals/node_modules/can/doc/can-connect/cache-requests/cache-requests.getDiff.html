	...
	<ul>
					...
					<li class="
						...
						<a class="function"
							...
							title="Only request data that hasn&#x27;t already been loaded by base.cacheConnection.">
							getListData
						</a>
	...
	<ul>
					...
					<li class="current
						...
						<a class="function"
							...
							title="Compares the available set data to the requested data and returns
...
from the base connection.">
					...
					<li class="
						...
						<a class="function"
							...
							title="Returns the union of the cached and needed data.">
							getUnion
						</a>
...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Compares the available set data to the requested data and returns
the data that should be loaded from the cache and the data loaded
from the base connection.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect/tree/v1.0.14/cache-requests/cache-requests.js#L102">source</a></li>
...
<div class="signature">
  ...
  <p>This attempts to find the minimal amount of data to load by
going through each <code>availableSet</code> and doing a <a href="https://github.com/canjs/can-set#setsubset">subset</a>
test and a <a href="https://github.com/canjs/can-set#setdifference">set difference</a> with
<code>set</code>.</p>
<p>If <code>set</code> is a subset of an <code>availableSet</code>, <code>{cached: set}</code> will be returned.</p>
<p>If there is a difference of <code>set</code> and an <code>availableSet</code>, the difference
will be what's <code>needed</code>.  The intersection of <code>set</code> and that
<code>availableSet</code> will be what's <code>cached</code>.  A <code>count</code> will be taken of
what's <code>needed</code> resulting in an object like:</p>
<pre><code>{
...
<p>Finally, <code>getDiff</code> will pick the diff objet with the lowest count. If there
is no diff object, <code>{needed: set}</code> is returned.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>set</b> <code>{<a href="../../can-set/Set.html" title="An object that represents a set of data.">Set</a>}</code>: <p>The set that is being loaded.</p>
</li>
        
          <li><b>availableSets</b> <code>{Array&lt;Set&gt;}</code>: <p>An array of available sets in the
<a href="../base/base.cacheConnection.html" title="A connection used for caching.">cacheConnection</a>.</p>
</li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-connect/cache-requests/cache-requests.getDiff","parent":"can-connect/cache-requests/cache-requests.algebra","src":{"line":102,"codeLine":143,"path":"node_modules/can-connect/cache-requests/cache-requests.js"},"description":"\nCompares the available set data to the requested data and returns\nthe data that should be loaded from the cache and the data loaded\nfrom the base connection.\n","title":"getDiff","signatures":[{"code":"connection.getDiff( set, availableSets )","description":"\n\n  This attempts to find the minimal amount of data to load by\n  going through each `availableSet` and doing a [subset](https://github.com/canjs/can-set#setsubset)\n  test and a [set difference](https://github.com/canjs/can-set#setdifference) with\n  `set`.\n\n  If `set` is a subset of an `availableSet`, `{cached: set}` will be returned.\n\n  If there is a difference of `set` and an `availableSet`, the difference\n  will be what's `needed`.  The intersection of `set` and that\n  `availableSet` will be what's `cached`.  A `count` will be taken of\n  what's `needed` resulting in an object like:\n\n  ```\n  {\n    needed: {start: 50, end: 99},\n    cached: {start: 0, end: 49},\n    count: 49\n  }\n  ```\n\n  Finally, `getDiff` will pick the diff objet with the lowest count. If there\n  is no diff object, `{needed: set}` is returned.\n\n","params":[{"types":[{"type":"can-set/Set"}],"name":"set","description":"The set that is being loaded."},{"types":[{"type":"Array","template":[{"types":[{"type":"Set"}]}]}],"name":"availableSets","description":"An array of available sets in the\n[can-connect/base/base.cacheConnection]."}],"returns":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[{"name":"needs","types":[{"type":"Set"}]},{"name":"cached","types":[{"type":"Set"}]}]}]}]}],"description":"\n\n\n\t "}}],"_curParam":{"types":[{"type":"Array","template":[{"types":[{"type":"Set"}]}]}],"name":"availableSets","description":"An array of available sets in the\n[can-connect/base/base.cacheConnection]."},"_curReturn":{"types":[{"type":"Promise","template":[{"types":[{"type":"Object","options":[{"name":"needs","types":[{"type":"Set"}]},{"name":"cached","types":[{"type":"Set"}]}]}]}]}],"description":"\n\n\n\t "},"pathToRoot":"../../.."};
</script>
</article>
