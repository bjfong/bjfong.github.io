...
<section class="title-footer">
		...
		<ul class="title-social">
			...
			<li>
			<a class="github-button nav-social" href="https://github.com/canjs/can-map-backup"
				data-count-href="/canjs/can-map-backup/stargazers"
				data-count-api="/repos/canjs/can-map-backup#stargazers_count">Star</a>
	  	</li>
		</ul>
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-map-backup/tree/v3.0.2/doc/can-map-backup.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-map-backup/doc/can-map-backup.md"},"description":"\n","type":"module","title":"","types":[{"type":"can-map"}],"name":"can-map-backup","parent":"can-legacy","test":"src/test/test.html","package":{"author":{"email":"contact@bitovi.com","name":"Bitovi","url":"http://bitovi.com"},"dependencies":{"can-compute":"^3.0.0","can-connect":"^1.0.0","can-fixture":"^1.0.0","can-jquery":"^3.0.1","can-list":"^3.0.0","can-map":"^3.0.1","can-set":"^1.0.0","can-util":"^3.0.1"},"description":"Backup and restore a Maps state","devDependencies":{"can-map-define":"^3.0.0-pre.2","can-ssr":"^0.11.6","documentjs":"^0.4.2","donejs-cli":"^0.7.0","generator-donejs":"^0.7.0","jshint":"^2.9.1","steal":"^0.14.0","steal-qunit":"^0.1.1","steal-tools":"^0.14.0","testee":"^0.2.4"},"directories":{},"dist":{"shasum":"2cb30e4aeb8f3083b3cfe329f51efe45bf0c27d2","tarball":"https://registry.npmjs.org/can-map-backup/-/can-map-backup-3.0.2.tgz"},"gitHead":"fe5dbe39ef53a7b9597abeb915c3ca076da1084d","homepage":"https://canjs.com","keywords":["canjs"],"main":"can-map-backup","maintainers":[{"email":"daff@neyeon.de","name":"daffl"},{"email":"ivan.herndon@gmail.com","name":"iherndon"},{"email":"jandjorgensen@gmail.com","name":"jandjorgensen"},{"email":"justin@bitovi.com","name":"justinbmeyer"},{"email":"matthew@matthewphillips.info","name":"matthewp"}],"name":"can-map-backup","optionalDependencies":{},"scripts":{"build":"node build.js","develop":"can-serve --static --develop --port 8080","document":"documentjs","jshint":"jshint *.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","release:pre":"npm version prerelease && npm publish","test":"npm run jshint && npm run testee","testee":"testee test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"system":{"configDependencies":["live-reload"],"main":"can-map-backup","npmAlgorithm":"flat","npmIgnore":["documentjs","testee","generator-donejs","donejs-cli","steal-tools"]},"version":"3.0.2"},"signatures":[{"code":"require('can-map-backup')","description":"\n\nAdds a [can-map-backup/can-map.prototype.backup],\n[can-map-backup/can-map.prototype.isDirty] and\n[can-map-backup/can-map.prototype.restore] method to [can-map].\n","params":[],"returns":{"types":[{"type":"can-map"}],"description":"Exports [can-map].\n"}}],"_curReturn":{"types":[{"type":"can-map"}],"description":"Exports [can-map].\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
