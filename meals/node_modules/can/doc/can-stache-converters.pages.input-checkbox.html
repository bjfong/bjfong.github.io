...
<!--####################################################################
	...
	@page can-stache-converters.pages.input-checkbox
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="can-stache-converters.pages.input-checkbox.html">input[type=checkbox]</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-stache-converters/tree/v3.0.4/docs/input-checkbox.md">source</a></li>
...
<p>An alternative true and false value can be specified by using [can-stache.converters.either-or]. This is used for setting up a &quot;boolean&quot; property that only has two possible valid values, whose values are modelled by the true/false checked property of a checkbox, as in the following example:</p>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-stache-converters/docs/input-checkbox.md"},"description":"\nCross bind a value to a checkbox.\n","name":"can-stache-converters.pages.input-checkbox","title":"input[type=checkbox]","type":"page","parent":"can-stache-converters.pages","comment":" ","pathToRoot":".."};
</script>
</article>
