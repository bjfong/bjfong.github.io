...
<head>
	<meta charset="utf-8">
	<title>CanJS - Show a List in a Template</title>
...
<div class="breadcrumb">
	...
	<li><a href="ShowAList.html">Show a List in a Template</a></li>
  ...
  <section class="title">
	<div class="page-type">
		<h1>Show a List in a Template</h1>
		<div>page</div>
	</div>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/docs/can-guides/recipes/recipes-show-a-list.md">source</a></li>
...
<p>To show a list of data within a stache template, use the <code>#each</code> operator.</p>
<pre><code>&lt;ul&gt;
{{#each people}}
  &lt;li&gt;
    {{lastname}}, {{firstname}}
...
<script type="text/javascript">
  var docObject = {"src":{"path":"docs/can-guides/recipes/recipes-show-a-list.md"},"description":"\n","name":"ShowAList","title":"Show a List in a Template","type":"page","parent":"Recipes","order":3,"comment":" ","pathToRoot":".."};
</script>
</article>
