...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/docs/can-guides/experiment/chat/chat.md">source</a></li>
...
<p>Read <a href="setup.html" title="Get started with CanJS by installing it with npm, using a JS Bin, or just adding it to an HTML page with a &lt;script&gt; tag.">Setting up CanJS</a> on how to setup CanJS in a real app.
...
message, and it will appear in the first JSBin's messages list.</p>
...
<p><a class="jsbin-embed" href="//jsbin.com/mopiyu/3/embed?html,js,output">JS Bin on jsbin.com</a></p>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"docs/can-guides/experiment/chat/chat.md"},"description":"This guide walks through building real time chat application with CanJS's [can-core Core libraries].  It takes about 30 minutes to complete.\n\n","name":"guides/chat","title":"Chat Guide","type":"page","parent":"guides/experiment","order":1,"templateRender":["<%","%>"],"comment":" ","pathToRoot":"../.."};
</script>
</article>
