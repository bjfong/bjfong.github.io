...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/docs/can-guides/experiment/todomvc/todomvc.md">source</a></li>
...
<p>Read <a href="setup.html" title="Get started with CanJS by installing it with npm, using a JS Bin, or just adding it to an HTML page with a &lt;script&gt; tag.">Setting up CanJS</a> on how to setup CanJS in a real app.</p>
...
<li>Call the <code>todo</code>'s <a href="../can-connect/can/map/map.prototype.destroy.html" title="Delete's the instance with the connection.">destroy</a> method when the <code>&lt;button&gt;</code> is clicked using <a href="../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">(event)</a>.</li>
</ul>
<pre><code class="language-html">&lt;!DOCTYPE html&gt;
&lt;html&gt;
&lt;head&gt;
...
<li>Calls <code>createTodo</code> when the <code>enter</code> key is pressed using <a href="../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">(event)</a>.</li>
</ul></li>
...
<li>Setup the edit input to:
<ul>
<li>Two way bind its value to the current todo's <code>name</code> using <a href="../can-stache-bindings.twoWay.html" title="Two-way bind a value in the viewModel or the element to the parent scope.">{(two-way)}</a>.</li>
<li>Call <code>updateName</code> when the enter key is pressed using <a href="../can-stache-bindings.event.html" title="Respond to events on elements or component ViewModels.">(event)</a>.</li>
...
<p>In this section, we will:</p>
<ul>
<li>Make it possible to use the forward and backwards button to change
...
<h2>Result</h2>
<p>When finished, you should see something like the following JSBin:</p>
<p><a class="jsbin-embed" href="http://jsbin.com/labajog/1/embed?html,js,output">JS Bin on jsbin.com</a></p>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"docs/can-guides/experiment/todomvc/todomvc.md"},"description":"This guide walks through building a slightly modified version of [TodoMVC](http://todomvc.com/) with CanJS's [can-core Core libraries] and [can-fixture]. It takes about 1 hour to complete.\n\n","name":"guides/todomvc","title":"TodoMVC Guide","type":"page","parent":"guides/experiment","order":2,"templateRender":["<%","%>"],"comment":" ","pathToRoot":"../.."};
</script>
</article>
