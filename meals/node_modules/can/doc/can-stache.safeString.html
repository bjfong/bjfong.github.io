...
<div class="breadcrumb">
	...
	<li><a href="can-stache.safeString.html">safeString</a></li>
  ...
  <section class="title">
    ...
    <p>Indicate that a string does not need to be escaped to be safely inserted into the page.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-stache/tree/v3.0.13/docs/safeString.md">source</a></li>
...
<div class="signature">
  ...
  <p>By default, stache tries to prevent some common forms of <a href="https://en.wikipedia.org/wiki/Cross-site_scripting">cross site scripting attacks</a> by escaping content passed
to tags like <a href="can-stache.tags.escaped.html" title="Insert the value of the expression into the output of the template.">{{expression}}</a> and the result of helpers.  However,
one will often need to create helpers that return HTML content that shouldn't be escaped.</p>
<p><code>stache.safeString</code> can be used to indicate that a returned string from a helper is safe:</p>
<pre><code class="language-js">stache.registerHelper(&quot;myHelper&quot;, function(){
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>str</b> <code>{String}</code>: <p>A string you don't want to become escaped.</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>A string flagged by <code>stache</code> as safe, which will
not become escaped, even if you use <a href="can-stache.tags.escaped.html" title="Insert the value of the expression into the output of the template.">{{expression}}</a>.</p>
</p>
  </div>
    ...
    <section class="body">
    <h2>Use</h2>
<p>If you write a helper that generates its own HTML, you will
usually want to return a <code>stache.safeString.</code> In this case,
you will want to manually escape parameters with <a href="can-util/js/string/string.esc.html" title="can-util/js/string/string.esc">string.esc</a>.</p>
...
<p>Rendering:</p>
<pre><code>&lt;div&gt;{{link &quot;Google&quot;, &quot;http://google.com&quot;}}&lt;/div&gt;
</code></pre>
<p>Results in:</p>
<pre><code>&lt;div&gt;&lt;a href=&quot;http://google.com&quot;&gt;Google&lt;/a&gt;&lt;/div&gt;
</code></pre>
<p>As an anchor tag whereas if we would have just returned the result rather than a
<code>stache.safeString</code> our template would have rendered a div with the escaped anchor tag.</p>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-stache/docs/safeString.md"},"description":"Indicate that a string does not need to be escaped to be safely inserted into the page.\n\n","title":"safeString","name":"can-stache.safeString","type":"function","parent":"can-stache.static","signatures":[{"code":"stache.safeString(str)","description":"\n\nBy default, stache tries to prevent some common forms of [cross site scripting attacks](https://en.wikipedia.org/wiki/Cross-site_scripting) by escaping content passed\nto tags like [can-stache.tags.escaped] and the result of helpers.  However,\none will often need to create helpers that return HTML content that shouldn't be escaped.\n\n`stache.safeString` can be used to indicate that a returned string from a helper is safe:\n\n```js\nstache.registerHelper(\"myHelper\", function(){\n  return stache.safeString(\"<blink>Hello There!</blink>\");\n})\n```\n","params":[{"types":[{"type":"String"}],"name":"str","description":"A string you don't want to become escaped."}],"returns":{"types":[{"type":"String"}],"description":"A string flagged by `stache` as safe, which will\nnot become escaped, even if you use [can-stache.tags.escaped].\n"}}],"_curParam":{"types":[{"type":"String"}],"name":"str","description":"A string you don't want to become escaped."},"_curReturn":{"types":[{"type":"String"}],"description":"A string flagged by `stache` as safe, which will\nnot become escaped, even if you use [can-stache.tags.escaped].\n"},"comment":" ","pathToRoot":".."};
</script>
</article>
