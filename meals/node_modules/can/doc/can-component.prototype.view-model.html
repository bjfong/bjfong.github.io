...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Return the view model instance or type with which the component's <a href="can-component.prototype.view.html" title="Provides a template to render directly within the component's element. The template is rendered with the
component's can-component::ViewModel instance.  &lt;content/&gt; elements within the template are replaced by the source elements within the component's tag.">view</a>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-component/tree/v3.0.3/docs/view-model.md">source</a></li>
...
and returns either the view-model instance or ViewModel type that the component's <a href="can-component.prototype.view.html" title="Provides a template to render directly within the component's element. The template is rendered with the
component's can-component::ViewModel instance.  &lt;content/&gt; elements within the template are replaced by the source elements within the component's tag.">view</a>
is rendered with.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>properties</b> <code>{Object}</code>: <p>An object of values specified by the custom element's attributes. For example, a template rendered like:</p>
...
<li>The prototype of an observable map or list type that will be used to render the component's template.</li>
</ul>
</p>
  </div>
