...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/docs/can-guides/observables.md">source</a></li>
    ...
    <section class="body">
    <p>CanJS's observables - <a href="../docs/can.Map.html">can.Map</a>, <a href="../docs/can.List.html">can.List</a>,
...
<ul>
<li><a href="../docs/can.Map.html">can.Map</a> - Used for Objects.</li>
...
<p>can.Map and can.List are often extended to create observable types.
...
arrays:</p>
<ul>
<li><a href="../docs/can.List.prototype.indexOf.html">indexOf</a>, which looks for an item in a
List.</li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"docs/can-guides/observables.md"},"description":"\n","name":"Observables","title":"Observables","type":"page","parent":"Tutorial","order":1,"comment":" ","pathToRoot":".."};
</script>
</article>
