...
<div class="breadcrumb">
  ...
  <section class="title">
    ...
    <p>Serialize an object into a query string.</p>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/param/param.js#L34">source</a></li>
...
<div class="signature">
  ...
  <p>Serializes an object or array into a query string useful for making Ajax requests or the
browser. <code>param</code> handles nested objects and arrays.  It uses <code>encodeURIComponent</code> to
escape values and keys.</p>
<pre><code class="language-js">param({a: &quot;b&quot;, c: &quot;d&quot;}) //-&gt; &quot;a=b&amp;c=d&quot;
param({a: [&quot;X&quot;,&quot;Y&quot;]})   //-&gt; &quot;a[]=X&amp;a[]=Y&quot;
</code></pre>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>params</b> <code>{Object}</code>: <p>[description]</p>
</li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{String}</code>: <p>[description]</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"module","name":"can-util/js/param/param","parent":"can-util/js","src":{"line":34,"codeLine":54,"path":"node_modules/can-util/js/param/param.js"},"description":"\nSerialize an object into a query string.\n","title":"param","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"signatures":[{"code":"param(params)","description":"\n\n  Serializes an object or array into a query string useful for making Ajax requests or the\n  browser. `param` handles nested objects and arrays.  It uses `encodeURIComponent` to\n  escape values and keys.\n\n  ```js\n  param({a: \"b\", c: \"d\"}) //-> \"a=b&c=d\"\n  param({a: [\"X\",\"Y\"]})   //-> \"a[]=X&a[]=Y\"\n  ```\n","params":[{"types":[{"type":"Object","options":[]}],"name":"params","description":"[description]"}],"returns":{"types":[{"type":"String"}],"description":"[description]\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"name":"params","description":"[description]"},"_curReturn":{"types":[{"type":"String"}],"description":"[description]\n"},"pathToRoot":"../../../.."};
</script>
</article>
