...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/string/string.js#L223">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-util/js/string/string.strReplacer","type":"property","parent":"can-util/js/string/string","src":{"line":223,"codeLine":228,"path":"node_modules/can-util/js/string/string.js"},"description":"\nThe regex used to find replacement sections in [can-util/js/string/string.sub string.sub]\n","types":[{"type":"RegExp"}],"title":"string.strReplacer","pathToRoot":"../../../.."};
</script>
</article>
