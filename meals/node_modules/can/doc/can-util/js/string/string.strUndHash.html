...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/string/string.js#L229">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-util/js/string/string.strUndHash","type":"property","parent":"can-util/js/string/string","src":{"line":229,"codeLine":234,"path":"node_modules/can-util/js/string/string.js"},"description":"\nA regex which matches an underscore or hyphen character\n","types":[{"type":"RegExp"}],"title":"string.strUndHash","pathToRoot":"../../../.."};
</script>
</article>
