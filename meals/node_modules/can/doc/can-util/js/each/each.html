...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/each/each.md">source</a></li>
...
<div class="signature">
  ...
  <p>Loop over each element in an Array-Like data structure.</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>elements</b> <code>{Object|ArrayLike}</code>: </li>
        
          <li><b>callback</b> <code>{function(element, key, <a href="../../../elements.html" title="This module must be CJS format because is uses with () { ... }
statements which will not work in ES6 since it forces strict mode.">elements</a>)}</code>: </li>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{ArrayLike}</code>: <p>the orignal array of elements</p>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-util/js/each/each.md"},"description":"\n","type":"module","title":"each","types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[]}],"name":"can-util/js/each/each","parent":"can-util/js","signatures":[{"code":"each(elements, callback, context)","description":"\n\nLoop over each element in an Array-Like data structure.\n","params":[{"types":[{"type":"Object"},{"type":"ArrayLike"}],"name":"elements","description":""},{"types":[{"type":"function","returns":{"types":[{"type":"undefined"}]},"params":[{"types":[{"type":"element"}]},{"types":[{"type":"key"}]},{"types":[{"type":"elements"}]}]}],"name":"callback","description":""},{"types":[{"type":"Object","options":[]}],"optional":true,"name":"context","description":"the context object\n"}],"returns":{"types":[{"type":"ArrayLike"}],"description":"the orignal array of elements\n\n```js\n var each = require(\"can-util/js/each/each\");\n \n each([2,1,0], function(i) { console.log(this[i]); }, [4,5,6]); // -> 6 \\n 5 \\n 4\n```\n"}}],"_curParam":{"types":[{"type":"Object","options":[]}],"optional":true,"name":"context","description":"the context object\n"},"_curReturn":{"types":[{"type":"ArrayLike"}],"description":"the orignal array of elements\n\n```js\n var each = require(\"can-util/js/each/each\");\n \n each([2,1,0], function(i) { console.log(this[i]); }, [4,5,6]); // -> 6 \\n 5 \\n 4\n```\n"},"pathToRoot":"../../../.."};
</script>
</article>
