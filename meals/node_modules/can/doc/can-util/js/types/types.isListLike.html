...
<!--####################################################################
	...
	@function can-util/js/types/types.isListLike
######################################################################## -->
<html lang="en">
<head>
	<meta charset="utf-8">
...
<div class="breadcrumb">
	...
	<li><a href="types.isListLike.html">isListLike</a></li>
...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/js/types/types.js#L42">source</a></li>
...
<div class="signature">
  <h2 class="signature-title">
    <code>types.isListLike(obj)</code>
  </h2>
  <p>Returns true if <code>obj</code> is an observable list-type object with numeric keys and a length.</p>

  
  
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{Boolean}</code>: <p><code>true</code> if the object is list like.</p>
</p>
  </div>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-util/js/types/types.isListLike","parent":"can-util/js/types/types","src":{"line":42,"codeLine":49,"path":"node_modules/can-util/js/types/types.js"},"description":"","title":"isListLike","signatures":[{"code":"types.isListLike(obj)","description":"\n  Returns true if `obj` is an observable list-type object with numeric keys and a length.\n","params":[],"returns":{"types":[{"type":"Boolean"}],"description":"`true` if the object is list like.\n "}}],"_curReturn":{"types":[{"type":"Boolean"}],"description":"`true` if the object is list like.\n "},"pathToRoot":"../../../.."};
</script>
</article>
