...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/dom/class-name/class-name.js#L10">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-util/dom/class-name/class-name","type":"module","parent":"can-util/dom","src":{"line":10,"codeLine":23,"path":"node_modules/can-util/dom/class-name/class-name.js"},"description":"Allows querying and manipulation of classes on HTML elements \n```js\nvar className = require(\"can-util/dom/class-name/class-name\");\n\nvar fooDiv = document.createElement(\"div\");\nclassName.add(fooDiv, \"foo\");\nfooDiv.outerHTML; //-> '<div class=\"foo\"></div>'\n```\n\n","title":"className","types":[{"type":"Object","options":[]}],"pathToRoot":"../../../.."};
</script>
</article>
