...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/dom/data/data.js#L51">source</a></li>
...
<script type="text/javascript">
  var docObject = {"name":"can-util/dom/data/data.expando","type":"property","parent":"can-util/dom/data/data","src":{"line":51,"codeLine":57,"path":"node_modules/can-util/dom/data/data.js"},"description":"\nThe key in which elements' cids are stored\n","types":[],"title":"domData.expando","pathToRoot":"../../../.."};
</script>
</article>
