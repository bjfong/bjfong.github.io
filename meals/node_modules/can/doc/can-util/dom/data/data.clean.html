...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/dom/data/data.js#L58">source</a></li>
...
<pre><code class="language-js">domData.clean.call(el, &quot;metadata&quot;);
</code></pre>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-util/dom/data/data.clean","parent":"can-util/dom/data/data","src":{"line":58,"codeLine":69,"path":"node_modules/can-util/dom/data/data.js"},"description":"","title":"domData.clean","signatures":[{"code":"domData.clean.call(el, key)","description":"\n\nRemove data from an element previously added by [can-util/dom/data/data.set set]\n\n```js\ndomData.clean.call(el, \"metadata\");\n```\n ","params":[]}],"pathToRoot":"../../../.."};
</script>
</article>
