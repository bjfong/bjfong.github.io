...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-util/tree/v3.0.13/dom/mutate/mutate.js#L143">source</a></li>
...
<script type="text/javascript">
  var docObject = {"type":"function","name":"can-util/dom/mutate/mutate.removeChild","parent":"can-util/dom/mutate/mutate","src":{"line":143,"codeLine":148,"path":"node_modules/can-util/dom/mutate/mutate.js"},"description":"","title":"removeChild","signatures":[{"code":"mutate.removeChild.call(el, child)","description":"\nLike mutate.appendChild, used to insert a node to an element before a reference node and then trigger the \"removed\" event.\n ","params":[]}],"pathToRoot":"../../../.."};
</script>
</article>
