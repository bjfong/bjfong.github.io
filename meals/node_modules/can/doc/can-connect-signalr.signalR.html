...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-connect-signalr/tree/v0.0.1/docs/signalR.md">source</a></li>
  ...
  <h3 class="options-title">Options</h3>
    <ul>
      ...
      <li>
        ...
        <pre><code>This is used to name the hub, and generate the default `createName`, `updateName`, etc.
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-connect-signalr/docs/signalR.md"},"description":"\n","types":[{"type":"Object","options":[{"name":"name","description":"\n    This is used to name the hub, and generate the default `createName`, `updateName`, etc.\n\n    So if your name is `\"messages\"`, this is like settings.\n","types":[{"type":"String"}]},{"name":"createName","description":"\n","types":[{"type":"String"}]}],"description":"\n"}],"title":"signalR","name":"can-connect-signalr.signalR","type":"property","parent":"can-connect-signalr","pathToRoot":".."};
</script>
</article>
