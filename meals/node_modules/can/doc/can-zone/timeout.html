...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-zone/tree/v0.6.0/docs/zones/timeout.md">source</a></li>
...
Using these hooks you can do things like create timers and override global variables that will change the shape of code that runs within the Zone.">ZoneSpec</a> that you can use as a plugin for your <a href="../can-zone.html" title="">Zone</a> in order to timeout after a certain length of time (as <code>ms</code>).</p>
  ...
  <div class="parameters">
    <h3 class="parameters-title">Parameters</h3>
      <ol>
          ...
          <li><b>ms</b> <code>{Number}</code>: <p>The number of milliseconds to wait before timing out the <a href="../can-zone.html" title="">Zone</a>.</p>
</li>
