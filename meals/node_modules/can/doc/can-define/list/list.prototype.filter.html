...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/node_modules/can-define/list/list.js#L905">source</a></li>
...
excluded.</p>
  ...
  <div class="returns">
    <h3 class="returns-title">Returns</h3>
     <p> <code>{<a href="list.html" title="Create observable lists.">can-define/list/list</a>}</code>: <p>A <code>DefineList</code> of the same type.</p>
</p>
  </div>
