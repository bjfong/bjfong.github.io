...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-view-callbacks/tree/v3.0.2/docs/attr.md">source</a></li>
...
that matches attribute names. Examples: <code>&quot;my-fill&quot;</code> or <code>/my-\w/</code>.</p>
          ...
          <li><b>attrHandler</b> <code>{function(el, <a href="can-view-callbacks.attrData.html" title="The data provided to can-view-callbacks.attr.">attrData</a>)}</code>: <p>A function that adds custom behavior to <code>el</code>.</p>
</li>
