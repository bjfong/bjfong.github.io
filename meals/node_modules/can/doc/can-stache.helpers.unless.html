...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-stache/tree/v3.0.13/docs/helpers/unless.md">source</a></li>
...
current scope.</p>
<pre><code>{{#unless person.isAwake() }} Shhhhh! {{/if}}
</code></pre>
