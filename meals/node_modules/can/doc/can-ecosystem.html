...
<section class="title-footer">
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/canjs/tree/v3.2.0/docs/can-canjs/can-ecosystem.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"docs/can-canjs/can-ecosystem.md"},"description":"Useful libraries that extend or add important features to the core collection. \n","name":"can-ecosystem","title":"Ecosystem","type":"page","parent":"canjs","order":3,"comment":" ","pathToRoot":".."};
</script>
</article>
