...
<section class="title-footer">
		...
		<ul class="title-social">
			<li>
				<a class="npm-button" href="https://www.npmjs.com/package/can-fixture-socket">
					<img src="https://img.shields.io/badge/npm%20package-0.5.8-brightgreen.svg" alt="npm package badge" />
				</a>
			</li>
			<li>
			<a class="github-button nav-social" href="https://github.com/canjs/can-fixture-socket"
				data-count-href="/canjs/can-fixture-socket/stargazers"
				data-count-api="/repos/canjs/can-fixture-socket#stargazers_count">Star</a>
	  	</li>
		</ul>
		...
		<ul class="title-links">
			...
			<li><a href="//github.com/canjs/can-fixture-socket/tree/v0.5.8/can-fixture-socket.md">source</a></li>
...
<script type="text/javascript">
  var docObject = {"src":{"path":"node_modules/can-fixture-socket/can-fixture-socket.md"},"description":"Simulate socket.io services. \n\n\n","type":"module","title":"","types":[{"type":"Object","options":[],"description":"\n\n`can-fixture-socket` intercepts socket.io messages and simulates socket.io server responses.\n\nThe `can-fixture-socket` module exports an object with:\n\n- [can-fixture-socket.Server], a constructor function which instance intercepts the socket.io connection;\n- [can-fixture-socket.requestHandlerToListener], a helper to convert XHR request handler into [can-fixture-socket.socket-event-listener];\n- [can-fixture-socket.storeToListeners], a helper to convert all [can-fixture/StoreType] request handlers into [can-fixture-socket.socket-event-listener].\n\nWith three simple steps you can test your real-time application that uses socket.io:\n\n 1. create a mock server that intercepts socket.io;\n 2. mock server behavior;\n 3. test your application.\n\n```js\nvar fixtureSocket = require(\"can-fixture-socket\");\n\n// Import socket-io client:\nvar io = require(\"socket.io-client\");\n\n// Create a mock server that intercepts socket.io:\nvar mockServer = new fixtureSocket.Server(io);\n\n// Mock server behavior\nmockServer.on(\"connection\", function(){\n  mockServer.emit(\"notifications\", {test: \"OK\"})\n});\n\n// Client. Create socket.io connection:\nvar socket = io(\"http://localhost:8080/api\");\n\n// Test your application:\nsocket.on(\"connect\", function(){\n  assert.ok(true, \"socket connected\");\n});\n\nsocket.on(\"notifications\", function(data){\n  assert.deepEqual(data, {test: \"OK\"}, \"received notifications message\");\n});\n```\n"}],"name":"can-fixture-socket","parent":"can-ecosystem","package":{"author":{"email":"contact@bitovi.com","name":"bitovi","url":"bitovi.com"},"bugs":{"url":"https://github.com/canjs/can-fixture-socket/issues"},"dependencies":{"can-fixture":"^1.0.0","can-util":"^3.0.0"},"description":"Simulate socket connections","devDependencies":{"can-set":"^1.0.0","documentjs":"^0.4.4","done-serve":"^0.3.0-pre.0","donejs-cli":"^0.10.0-pre.0","es6-promise-polyfill":"^1.2.0","feathers":"^2.0.2","feathers-hooks":"^1.5.8","feathers-socketio":"^1.4.1","generator-donejs":"^0.10.0-pre.0","jshint":"^2.9.1","object-assign":"^4.1.0","socket.io-client":"^1.5.0","steal":"^0.16.41","steal-qunit":"^0.1.4","steal-tools":"^0.16.8","testee":"^0.2.4"},"directories":{},"dist":{"shasum":"5b98005f65c1ae3a0985fce818b9d48d89d12cc7","tarball":"https://registry.npmjs.org/can-fixture-socket/-/can-fixture-socket-0.5.8.tgz"},"gitHead":"5e37c75792a9a09e64fa5f0dce341ace803bd907","homepage":"https://github.com/canjs/can-fixture-socket","keywords":["Done","JS","Can","JS"],"main":"can-fixture-socket","maintainers":[{"email":"fadeev.ilya@gmail.com","name":"ilyavf"},{"email":"justin@bitovi.com","name":"justinbmeyer"}],"name":"can-fixture-socket","optionalDependencies":{},"repository":{"type":"git","url":"git://github.com/canjs/can-fixture-socket.git"},"scripts":{"build":"node build.js","develop":"done-serve --static --develop --port 8080","document":"documentjs","jshint":"jshint ./*.js --config","postversion":"git push --tags && git checkout master && git branch -D release && git push","preversion":"npm test && npm run build","release:major":"npm version major && npm publish","release:minor":"npm version minor && npm publish","release:patch":"npm version patch && npm publish","test":"npm run jshint && npm run testee","testee":"testee test/test.html --browsers firefox","version":"git commit -am \"Update dist for release\" && git checkout -b release && git add -f dist/"},"system":{"configDependencies":["live-reload"],"main":"can-fixture-socket","npmAlgorithm":"flat","npmIgnore":["documentjs","testee","generator-donejs","donejs-cli","steal-tools"]},"version":"0.5.8"},"comment":" ","pathToRoot":".."};
</script>
</article>
